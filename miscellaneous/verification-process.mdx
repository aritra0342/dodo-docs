...
You can begin the payout activation process at any time by submitting the required details from your dashboard.
...
1. Navigate to the **Payouts** section in your dashboard
2. Click **Activate Payouts** when the prompt appears
3. Complete the **Product Information Form** first
4. Submit all required payout details in the **Payout Details** section

<Note>
You can continue accepting payments normally during the activation process. Payouts will not be available until verification is complete.
</Note>
