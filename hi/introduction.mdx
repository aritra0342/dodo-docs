...
<Accordion title="Cursor/Claude Desktop के लिए त्वरित MCP सेटअप">
अपने MCP कॉन्फ़िगरेशन में दोनों सर्वरों को जोड़ें (`~/.cursor/mcp.json` या Claude Desktop कॉन्फ़िगरेशन):
