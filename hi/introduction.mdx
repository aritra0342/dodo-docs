...
हमारे फ्रेमवर्क एडाप्टर्स के साथ 10 पंक्तियों से कम कोड में इंटीग्रेट करें। हमारे अनुशंसित फ्रेमवर्क में से चुनें या सभी समर्थित विकल्पों का अन्वेषण करें।
...
<Card title="Better Auth" icon="shield" href="/developer-resources/better-auth-adaptor">
  अंतर्निहित इंटीग्रेशन के साथ प्रमाणीकरण फ्रेमवर्क
</Card>
...
हमारे हल्के भुगतान लिंक और सुरक्षित React Native SDKs के साथ समृद्ध इन-ऐप भुगतान अनुभव बनाएं जो iOS और Android के लिए अनुकूलित हैं।

<CardGroup cols={3}>
<Card title="मोबाइल इंटीग्रेशन गाइड" icon="book" href="/developer-resources/mobile-integration">
  मोबाइल अनुप्रयोगों में भुगतान इंटीग्रेट करने के लिए पूर्ण गाइड
</Card>

<Card title="React Native SDK" icon="mobile" href="/developer-resources/react-native-integration">
  iOS और Android के लिए मूल मोबाइल SDK जिसमें सहज भुगतान प्रवाह हैं
</Card>
...
Dodo Payments को अपने पसंदीदा उपकरणों और प्लेटफार्मों के साथ कनेक्ट करें ताकि कार्यप्रवाह को स्वचालित किया जा सके, सूचनाएँ भेजी जा सकें, और आपके भुगतान संचालन को बढ़ाया जा सके।

<Info>
**सब कुछ स्वचालित करें**: वास्तविक समय की सूचनाएँ सेट करें, कार्यप्रवाह को ट्रिगर करें, ग्राहक डेटा को समन्वयित करें, और अधिक हमारे बढ़ते इंटीग्रेशन पुस्तकालय के साथ।
</Info>
...
<Card title="सभी इंटीग्रेशन देखें" icon="puzzle-piece" href="/integrations/introduction">
  विस्तृत सेटअप गाइड के साथ हमारे इंटीग्रेशन का पूरा पुस्तकालय अन्वेषण करें
</Card>
