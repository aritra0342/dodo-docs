...
<Warning>
**MongoDB**: आपके डेटाबेस सर्वर पर `dodopayments_sync` नामक एक डेटाबेस स्वचालित रूप से बनाया जाएगा। सभी सिंक डेटा वहाँ संग्रहीत किया जाएगा। यह डेटाबेस नाम वर्तमान में निश्चित है और इसे बदला नहीं जा सकता।
...
**ClickHouse**: तालिकाएँ (`Subscriptions`, `Payments`, `Licenses`, `Customers`) ReplacingMergeTree इंजन का उपयोग करके बनाई जाएँगी। क्वेरी करते समय, सुनिश्चित करें कि डुप्लिकेट परिणामों को सुनिश्चित करने के लिए `FINAL` कीवर्ड का उपयोग करें।
</Warning>
