...
| `elementId` | `string` | हाँ | DOM तत्व का `id` जहां चेकआउट प्रदर्शित होना चाहिए। |
...
| `options.manualRedirect` | `boolean` | नहीं | जब सक्षम किया जाता है, तो चेकआउट स्वचालित रूप से पूर्णता के बाद पुनर्निर्देशित नहीं होगा। इसके बजाय, आपको `checkout.status` और `checkout.redirect_requested` घटनाएँ प्राप्त होंगी ताकि आप पुनर्निर्देशन को स्वयं संभाल सकें। |
...
SDK TypeScript में लिखा गया है और इसमें व्यापक प्रकार परिभाषाएँ शामिल हैं।
...
<Warning>
हमेशा `checkout.error` घटना को संभालें ताकि जब समस्याएँ उत्पन्न हों तो एक अच्छा उपयोगकर्ता अनुभव प्रदान किया जा सके।
</Warning>

## सर्वोत्तम प्रथाएँ

1. **उत्तरदायी डिज़ाइन**: सुनिश्चित करें कि आपका कंटेनर तत्व पर्याप्त चौड़ाई और ऊँचाई रखता है। iframe आमतौर पर अपने कंटेनर को भरने के लिए विस्तारित होगा।
2. **समन्वय**: अपने कस्टम ऑर्डर सारांश या मूल्य तालिकाओं को चेकआउट फ्रेम में उपयोगकर्ता जो देखता है उसके साथ समन्वयित रखने के लिए `checkout.breakdown` घटना का उपयोग करें।
3. **स्केलेटन राज्य**: `checkout.opened` घटना फायर होने तक अपने कंटेनर में लोडिंग संकेतक दिखाएँ।
4. **साफ़ करना**: जब आपका घटक अनमाउंट होता है, तो iframe और इवेंट लिस्नर्स को साफ करने के लिए `DodoPayments.Checkout.close()` को कॉल करें।

<Info>
डार्क मोड कार्यान्वयन के लिए, इनलाइन चेकआउट फ्रेम के साथ अनुकूल दृश्य एकीकरण के लिए `#0d0d0d` को पृष्ठभूमि रंग के रूप में उपयोग करने की सिफारिश की जाती है।
</Info>
...
- सुनिश्चित करें कि `elementId` `id` के साथ मेल खाता है जो वास्तव में DOM में मौजूद है।
- सुनिश्चित करें कि `displayType: 'inline'` को `Initialize` में पास किया गया था।
- जांचें कि `checkoutUrl` मान्य है। 
</Accordion>

<Accordion title="मेरे UI में कर अपडेट नहीं हो रहे हैं">
- सुनिश्चित करें कि आप `checkout.breakdown` घटना के लिए सुन रहे हैं।
- कर केवल तब गणना किए जाते हैं जब उपयोगकर्ता चेकआउट फ्रेम में एक मान्य देश और पोस्टल कोड दर्ज करता है।
</Accordion>
</AccordionGroup>
...
<Steps>
<Step title="Apple Pay डोमेन संघ फ़ाइल डाउनलोड और अपलोड करें">

[Apple Pay डोमेन संघ फ़ाइल](http://checkout.dodopayments.com/.well-known/apple-developer-merchantid-domain-association) डाउनलोड करें।

फाइल को `/.well-known/apple-developer-merchantid-domain-association` पर अपने वेब सर्वर पर अपलोड करें। उदाहरण के लिए, यदि आपकी वेबसाइट `example.com` है, तो फ़ाइल को `https://example.com/well-known/apple-developer-merchantid-domain-association` पर उपलब्ध कराएँ।

</Step>

<Step title="Apple Pay सक्रियण का अनुरोध करें">

**support@dodopayments.com** पर निम्नलिखित जानकारी के साथ ईमेल करें:

- आपका उत्पादन डोमेन URL (जैसे, `https://example.com`)
- अपने डोमेन के लिए Apple Pay सक्षम करने का अनुरोध

<Check>
आपको 1-2 कार्यदिवसों के भीतर पुष्टि प्राप्त होगी जब Apple Pay आपके डोमेन के लिए सक्षम हो जाएगा।
</Check>
...
2. सत्यापित करें कि Apple Pay बटन एक भुगतान विकल्प के रूप में दिखाई देता है
...
<Warning>
Apple Pay को आपके डोमेन के लिए सक्षम किया जाना चाहिए इससे पहले कि यह उत्पादन में भुगतान विकल्प के रूप में दिखाई दे। यदि आप Apple Pay की पेशकश करने की योजना बना रहे हैं तो लाइव जाने से पहले समर्थन से संपर्क करें।
</Warning>
