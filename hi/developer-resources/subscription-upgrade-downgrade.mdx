...
**लक्षण**: योजना परिवर्तन चार्ज विफल हो जाता है और सदस्यता `on_hold` स्थिति में चली जाती है

**क्या होता है**:
जब योजना परिवर्तन चार्ज विफल होता है, तो सदस्यता स्वचालित रूप से `on_hold` स्थिति में रखी जाती है। सदस्यता तब तक स्वचालित रूप से नवीनीकरण नहीं करेगी जब तक कि भुगतान विधि अपडेट न हो।
...
- [परिवर्तन योजना API](/api-reference/subscriptions/change-plan) की समीक्षा करें
- [ग्राहक क्रेडिट](/features/customer-credit) का अन्वेषण करें
- `subscription.on_hold` के लिए अलर्ट लागू करें
- हमारे [वेबहुक एकीकरण गाइड](/developer-resources/webhooks) को देखें
