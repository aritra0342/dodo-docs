...
| `/api/webhook` | POST | डोडो पेमेंट्स वेबहुक को संभालें |
...
<Accordion title="चेकआउट सत्र निर्माण विफल">
**सामान्य कारण:**
...
ngrok URL पर अपने [डोडो डैशबोर्ड](https://app.dodopayments.com/developer/webhooks) में वेबहुक URL अपडेट करें। सुनिश्चित करें कि आप अपने `.env` फ़ाइल को सही वेबहुक सत्यापन कुंजी के साथ अपडेट करें।
</Accordion>
