...
1. [DodoPayments डैशबोर्ड](https://app.dodopayments.com) पर जाएं → डेवलपर → वेबहुक्स
...
2. **डुप्लिकेट की जांच करता है** - एक ही इवेंट को दो बार संसाधित करने से रोकने के लिए वेबहुक आईडी का उपयोग करता है
3. **इवेंट को लॉग करता है** - ऑडिट ट्रेल के लिए `webhook_events` तालिका में कच्चे वेबहुक को संग्रहीत करता है
4. **इवेंट को संसाधित करता है** - Neon में ग्राहकों और सदस्यताओं को बनाता या अपडेट करता है
...
1. अपनी साइट का चयन करें → **Functions** टैब
2. `webhook` फ़ंक्शन पर क्लिक करें
3. वास्तविक समय के लॉग और कार्यान्वयन इतिहास को देखें
...
| Env vars उपलब्ध नहीं हैं | CLI या डैशबोर्ड में चर सेट करें, फिर पुनः तैनात करें |
