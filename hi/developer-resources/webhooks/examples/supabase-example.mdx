...
5. **साइनिंग सीक्रेट** को कॉपी करें
...
2. **Idempotency की जांच करता है** - डुप्लिकेट प्रोसेसिंग को रोकने के लिए वेबहुक ID को देखता है
3. **इवेंट को लॉग करता है** - `webhook_events` तालिका में कच्चे वेबहुक डेटा को स्टोर करता है
4. **अपडेट्स को प्रोसेस करता है** - Supabase क्लाइंट के माध्यम से ग्राहकों और सब्सक्रिप्शनों को बनाता या अपडेट करता है
...
<Note>
`--no-verify-jwt` ध्वज आवश्यक है क्योंकि वेबहुक्स JWT टोकन शामिल नहीं करते हैं। सुरक्षा वेबहुक सिग्नेचर सत्यापन द्वारा प्रदान की जाती है।
</Note>
...
| फ़ंक्शन नहीं मिला | सत्यापित करें कि प्रोजेक्ट रेफ सही है और फ़ंक्शन तैनात है |
