...
1. [DodoPayments डैशबोर्ड](https://app.dodopayments.com) → डेवलपर → वेबहुक्स पर जाएं
...
✅ **Idempotency** - वेबहुक आईडी के साथ डुप्लिकेट प्रसंस्करण को रोकता है  
✅ **घटना लॉगिंग** - `webhook_events` तालिका में पूर्ण ऑडिट ट्रेल  
✅ **त्रुटि प्रबंधन** - लॉग किया गया और पुनः प्रयास योग्य

> **नोट:** यह कार्यान्वयन तीन मुख्य सदस्यता घटनाओं (`subscription.active`, `subscription.cancelled`, `subscription.renewed`) को न्यूनतम फ़ील्ड के साथ संभालने का प्रदर्शन करता है। आप इसे अपनी आवश्यकताओं के आधार पर अतिरिक्त घटना प्रकारों और फ़ील्ड का समर्थन करने के लिए आसानी से बढ़ा सकते हैं।
...
2. **डुप्लिकेट की जांच करता है** - एक ही घटना को दो बार संसाधित करने से रोकने के लिए वेबहुक आईडी का उपयोग करता है
3. **घटना को लॉग करता है** - ऑडिट ट्रेल के लिए `webhook_events` तालिका में कच्चे वेबहुक को संग्रहीत करता है
4. **घटना को संसाधित करता है** - ग्राहकों और सदस्यताओं को बनाता या अपडेट करता है
5. **त्रुटियों को संभालता है** - विफलताओं को लॉग करता है और पुनः प्रयास के लिए घटना को अप्रसंस्कृत के रूप में चिह्नित करता है
...
| कार्यकर्ता तैनात नहीं हो रहा | `npm install` चलाएँ, `wrangler.toml` सिंटैक्स की जांच करें |
