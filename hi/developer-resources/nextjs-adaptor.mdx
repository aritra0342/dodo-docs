...
<Card title="चेकआउट हैंडलर" icon="cart-shopping" href="#checkout-route-handler">
    स्थिर, गतिशील और सत्र प्रवाह के साथ Dodo Payments चेकआउट को एकीकृत करें।
</Card>
...
<Info>
सभी उदाहरण मानते हैं कि आप Next.js ऐप राउटर का उपयोग कर रहे हैं।
</Info>

<Tabs>
<Tab title="चेकआउट हैंडलर">
  <Info>
  इस हैंडलर का उपयोग अपने Next.js ऐप में Dodo Payments चेकआउट को एकीकृत करने के लिए करें। स्थिर (GET), गतिशील (POST), और चेकआउट सत्र (POST) भुगतान प्रवाह का समर्थन करता है।
  </Info>
  <CodeGroup>
...
<Tab title="ग्राहक पोर्टल हैंडलर">
  <Info>
  इस हैंडलर का उपयोग ग्राहकों को Dodo Payments ग्राहक पोर्टल के माध्यम से अपनी सदस्यताओं और विवरणों का प्रबंधन करने की अनुमति देने के लिए करें।
  </Info>
  <CodeGroup>
...
<Tab title="वेबहुक हैंडलर">
  <Info>
  इस हैंडलर का उपयोग अपने Next.js ऐप में Dodo Payments वेबहुक घटनाओं को सुरक्षित रूप से प्राप्त और संसाधित करने के लिए करें।
  </Info>
  <CodeGroup>
...
<Info>
Dodo Payments आपके वेबसाइट में भुगतान एकीकृत करने के लिए तीन प्रकार के भुगतान प्रवाह का समर्थन करता है, यह एडाप्टर सभी प्रकार के भुगतान प्रवाह का समर्थन करता है।
</Info>
...
<Warning>
यदि <code>productId</code> गायब है, तो हैंडलर 400 प्रतिक्रिया लौटाता है। अमान्य क्वेरी पैरामीटर भी 400 प्रतिक्रिया का परिणाम देते हैं।
</Warning>
