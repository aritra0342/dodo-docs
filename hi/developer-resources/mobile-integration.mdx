...
<CardGroup cols={2}>
<Card title="त्वरित प्रारंभ" icon="rocket" href="#integration-workflow">
  4 सरल चरणों में अपने मोबाइल भुगतान इंटीग्रेशन को चालू करें
</Card>

<Card title="प्लेटफ़ॉर्म उदाहरण" icon="code" href="#platform-specific-integration">
...
<Steps>
<Step title="बैकेंड: चेकआउट सत्र बनाएं">
<Card title="चेकआउट सत्र API दस्तावेज़" icon="book" href="/developer-resources/checkout-session">
अपने बैकेंड में Node.js, Python, और अन्य का उपयोग करके चेकआउट सत्र बनाने के तरीके के बारे में जानें। समर्पित <strong>चेकआउट सत्र API</strong> दस्तावेज़ में पूर्ण उदाहरण और पैरामीटर संदर्भ देखें।
</Card>
<Note>
...
<Step title="मोबाइल: चेकआउट URL प्राप्त करें">
...
<Step title="मोबाइल: ब्राउज़र में चेकआउट खोलें">
भुगतान प्रसंस्करण के लिए एक सुरक्षित इन-ऐप ब्राउज़र में चेकआउट URL खोलें।

<Card 
  title="प्लेटफ़ॉर्म-विशिष्ट इंटीग्रेशन उदाहरण देखें" 
  icon="box" 
...
<Step title="बैकेंड: भुगतान पूर्णता को संभालें">
...
<Tip>
InAppBrowser का उपयोग करें ताकि मूल ब्राउज़र अनुभव हो सके। भुगतान कॉलबैक के लिए डीप लिंक को संभालें।
</Tip>
...
<Warning>
**क्षेत्रीय अनुपालन**: इन-ऐप भुगतान SDK में क्षेत्रीय प्रतिबंध होते हैं। **iOS** पर, मूल भुगतान SDK केवल **EU** (DMA शर्तों के तहत) में कानूनी हैं। **Android** पर, वे उपयोगकर्ता विकल्प बिलिंग (UCB) बाजारों में कानूनी हैं। अन्य क्षेत्रों के लिए, सुनिश्चित करें कि ऐप स्टोर और प्ले स्टोर अनुपालन के लिए ऊपर दिए गए चेकआउट लिंक दृष्टिकोण का उपयोग करें।
</Warning>

<Card 
  title="React Native SDK इंटीग्रेशन गाइड" 
  icon="mobile-screen" 
  href="/developer-resources/react-native-integration"
>
  डोडो के React Native SDK को मूल भुगतान शीट, पूर्ण अनुकूलन विकल्पों, और सीधे भुगतान प्रबंधन के साथ एकीकृत करने के लिए पूर्ण गाइड। इसमें सेटअप, कार्यान्वयन, और परीक्षण निर्देश शामिल हैं।
</Card>

<Info>
इन-ऐप भुगतान इंटीग्रेशन के लिए क्षेत्रीय अनुपालन आवश्यकताओं को समझने के लिए [ऐप स्टोर शुल्क बायपास गाइड](/features/bypassing-app-store-fees) की समीक्षा करें।
</Info>
...
<Tip>
भुगतान लिंक के लिए WebView का उपयोग करें। भुगतान पूर्णता का पता लगाने के लिए रीडायरेक्ट URL को संभालें।
</Tip>
...
<Check>
प्रश्नों या सहायता के लिए, संपर्क करें <a href="mailto:support@dodopayments.com">support@dodopayments.com</a>।
</Check>