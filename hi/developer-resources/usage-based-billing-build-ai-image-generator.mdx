...
**घटना का नाम**: यह महत्वपूर्ण है - इसे ठीक से कॉपी करें → `image.generated`
...
इसके अलावा, सुनिश्चित करें कि **फिक्स्ड प्राइस** `0` पर सेट है ताकि ग्राहकों को केवल उनके उपयोग के आधार पर शुल्क लिया जाए, बिना किसी आधार शुल्क के।
...
**प्रति इकाई मूल्य**: दर्ज करें → `0.05` (यह $0.05 प्रति इमेज है)

**मुफ्त थ्रेशोल्ड**: दर्ज करें → `10` (ग्राहकों को प्रति माह 10 मुफ्त इमेज मिलती हैं)
...
<Step title="अपनी ग्राहक ID खोजें">
