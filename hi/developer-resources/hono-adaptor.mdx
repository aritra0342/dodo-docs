...
<Tab title="वेबहुक हैंडलर">
  <Info>
  इस हैंडलर का उपयोग अपने Hono ऐप में Dodo Payments वेबहुक घटनाओं को सुरक्षित रूप से प्राप्त और संसाधित करने के लिए करें।
  </Info>
  <CodeGroup>
...
- एक बार के और आवर्ती भुगतानों दोनों का समर्थन करता है।
