...
`convex.config.ts` को संपादित करने के बाद, आवश्यक प्रकार उत्पन्न करने के लिए `npx convex dev` को एक बार चलाएँ।
</Step>
<Step title="पर्यावरण चर सेट करें">
अपने Convex डैशबोर्ड में पर्यावरण चर सेट करें (**सेटिंग्स** → **पर्यावरण चर**)। आप निम्नलिखित कमांड चलाकर डैशबोर्ड तक पहुँच सकते हैं:
...
- `DODO_PAYMENTS_WEBHOOK_SECRET` - आपका वेबहुक रहस्य (वेबहुक हैंडलिंग के लिए आवश्यक)
...
<Warning>
इस क्वेरी का उपयोग करने से पहले, सुनिश्चित करें कि आपने अपने `convex/schema.ts` फ़ाइल में उपयुक्त स्कीमा परिभाषित किया है या क्वेरी को अपने मौजूदा स्कीमा के अनुसार बदलें।
</Warning>
...
<Tab title="ग्राहक पोर्टल सेटअप">
  <Info>
  इस फ़ंक्शन का उपयोग ग्राहकों को Dodo Payments ग्राहक पोर्टल के माध्यम से अपनी सदस्यताओं और विवरणों का प्रबंधन करने की अनुमति देने के लिए करें। ग्राहक को `identify` फ़ंक्शन के माध्यम से स्वचालित रूप से पहचाना जाता है।
  </Info>
  <CodeGroup>
...
<Info>
ग्राहक को आपके DodoPayments सेटअप में कॉन्फ़िगर की गई `identify` फ़ंक्शन का उपयोग करके स्वचालित रूप से पहचाना जाता है। यह फ़ंक्शन ग्राहक का `dodoCustomerId` लौटाना चाहिए।
</Info>
