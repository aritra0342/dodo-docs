...
क्लिक करने के बाद, कर्सर की `mcp.json` में अपने वातावरण चर सेट करें **कर्सर सेटिंग्स** > **उपकरण और MCP** > **नया MCP सर्वर**।

**मैनुअल कॉन्फ़िगरेशन**

<Steps>
<Step title="कर्सर सेटिंग्स खोलें">
...
<Tab title="Claude Desktop">
क्लॉड डेस्कटॉप में डोडो भुगतान MCP सर्वर सेट करें ताकि आपके भुगतान डेटा तक संवादात्मक पहुंच सक्षम हो सके।
<Steps>
<Step title="कॉन्फ़िगरेशन फ़ाइल खोजें">
    क्लॉड डेस्कटॉप कॉन्फ़िगरेशन फ़ाइल खोजें:
...
क्लिक करने के बाद, VS कोड की `mcp.json` में अपने वातावरण चर सेट करें **कमांड पैलेट** > **MCP: उपयोगकर्ता कॉन्फ़िगरेशन खोलें**।
...
<Step title="विंडो को पुनः लोड करें">
    MCP सर्वर को सक्रिय करने के लिए VS कोड को पुनः लोड करें (`Cmd/Ctrl + Shift + P` > "विंडो को पुनः लोड करें")।
</Step>
</Steps>
</Tab>

<Tab title="Cline (VS Code)">
Cline (VS Code) में डोडो भुगतान MCP सर्वर सेट करें ताकि आपके भुगतान डेटा तक संवादात्मक पहुंच सक्षम हो सके।
<Steps>
...
<Step title="VS कोड को पुनः लोड करें">
    VS कोड विंडो को पुनः लोड करें (`Cmd/Ctrl + Shift + P` > "विंडो को पुनः लोड करें") ताकि MCP सर्वर कनेक्शन सक्रिय हो सके।
</Step>
</Steps>
</Tab>
