...
|---------|-----------------|-----------------|
| एकीकरण की गहराई | पृष्ठ के शीर्ष पर मोडल | पृष्ठ में पूरी तरह से एम्बेडेड |
...
<Tip>
**ओवरले चेकआउट** का उपयोग करें ताकि आपके मौजूदा पृष्ठों में न्यूनतम परिवर्तनों के साथ तेजी से एकीकरण हो सके। **इनलाइन चेकआउट** का उपयोग करें जब आप चेकआउट अनुभव और निर्बाध ब्रांडिंग पर अधिकतम नियंत्रण चाहते हैं।
</Tip>
...
<Card title="इनलाइन चेकआउट" icon="credit-card" href="/developer-resources/inline-checkout">
    अपने पृष्ठ में सीधे चेकआउट एम्बेड करें ताकि पूरी तरह से एकीकृत अनुभव हो सके।
</Card>
...
अधिक सहायता के लिए, हमारे [डिस्कॉर्ड समुदाय](https://discord.gg/bYqAp4ayYh) पर जाएं या हमारी डेवलपर समर्थन टीम से संपर्क करें।
