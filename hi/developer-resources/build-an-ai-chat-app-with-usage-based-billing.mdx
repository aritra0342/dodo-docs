...
**संघटित करें**: टाइप → `totalTokens`

**मापने की इकाई**: टाइप → `tokens`
...
**मुफ्त थ्रेशोल्ड**: दर्ज करें → `10000` (ग्राहकों को प्रति माह 10,000 मुफ्त टोकन मिलते हैं)
