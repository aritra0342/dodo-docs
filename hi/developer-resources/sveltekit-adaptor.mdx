---
title: SveleteKit एडेप्टर
description: अपने SveleteKit App Router प्रोजेक्ट के साथ Dodo Payments को एकीकृत
  करने के लिए हमारे SveleteKit एडेप्टर का उपयोग करना सीखें। चेकआउट, ग्राहक
...
<Card title="चेकआउट हैंडलर" icon="cart-shopping" href="#checkout-route-handler">
    अपने SveleteKit ऐप में Dodo Payments चेकआउट को एकीकृत करें।
</Card>
...
<Info>
सभी उदाहरण मानते हैं कि आप SveleteKit App Router का उपयोग कर रहे हैं।
</Info>

<Tabs>
<Tab title="चेकआउट हैंडलर">
  <Info>
  इस हैंडलर का उपयोग अपने SveleteKit ऐप में Dodo Payments चेकआउट को एकीकृत करने के लिए करें। स्थिर (GET), गतिशील (POST), और सत्र (POST) भुगतान प्रवाह का समर्थन करता है।
  </Info>
  <CodeGroup>
...
<Tab title="वेबहुक हैंडलर">
  <Info>
  इस हैंडलर का उपयोग अपने SveleteKit ऐप में Dodo Payments वेबहुक घटनाओं को सुरक्षित रूप से प्राप्त और संसाधित करने के लिए करें।
  </Info>
  <CodeGroup>
...
ग्राहक पोर्टल रूट हैंडलर आपको अपने SveleteKit एप्लिकेशन में Dodo Payments ग्राहक पोर्टल को सहजता से एकीकृत करने की अनुमति देता है।
