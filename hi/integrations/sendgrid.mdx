...
<Step title="Webhook अनुभाग खोलें">
  ...
  <Frame>
    <img src="/images/integrations/sendgrid.png" alt="Add Endpoint और एकीकरण ड्रॉपडाउन" />
  </Frame>
</Step>

<Step title="SendGrid चुनें">
  <b>SendGrid</b> एकीकरण कार्ड चुनें।
</Step>

<Step title="API Key दर्ज करें">
  कॉन्फ़िगरेशन में अपना SendGrid API Key प्रदान करें।
</Step>

<Step title="Transformation कॉन्फ़िगर करें">
