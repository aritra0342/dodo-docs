...
<Step title="DataFast स्क्रिप्ट स्थापित करें">
  सबसे पहले, अपने वेबसाइट पर DataFast ट्रैकिंग स्क्रिप्ट स्थापित करें। यह `datafast_visitor_id` कुकी बनाता है जो आपके आगंतुकों को ट्रैक करता है।
  
  अपने प्लेटफ़ॉर्म के लिए स्थापना निर्देशों के लिए [DataFast दस्तावेज़](https://datafa.st/docs) पर जाएं।
</Step>
...
<Accordion title="राजस्व सौंपना काम नहीं कर रहा">
...
- अतिरिक्त मार्गदर्शन के लिए DataFast के [भुगतान API दस्तावेज़](https://datafa.st/docs/payments-api) की समीक्षा करें
</Accordion>
