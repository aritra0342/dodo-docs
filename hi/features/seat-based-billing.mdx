...
|------|-------------|----------------|
| `prorated_immediately` | चक्र में शेष दिनों के लिए शुल्क लें | उपयोग न किए गए दिनों के लिए क्रेडिट |
| `difference_immediately` | पूर्ण सीट मूल्य चार्ज करें | भविष्य के नवीनीकरण पर क्रेडिट लागू करें |
...
| घटना | कब ट्रिगर किया गया | उपयोग का मामला |
|-------|----------------|----------|
...
| `subscription.renewed` | सदस्यता नवीनीकरण | पुष्टि करें कि सीट संख्या अपरिवर्तित है |
| `subscription.cancelled` | सदस्यता रद्द की गई | सभी सीटों को हटा दें |
