...
<Card title="Kassa-hanterare" icon="cart-shopping" href="#checkout-route-handler">
    Integrera Dodo Payments kassa i din Tanstack-app.
</Card>
...
<Tab title="Kassa-hanterare">
  <Info>
  Använd denna hanterare för att integrera Dodo Payments kassa i din Tanstack-app. Stöder statiska (GET), dynamiska (POST) och sessions (POST) betalningsflöden.
  </Info>
  <CodeGroup>
...
<Tab title="Webhook-hanterare">
  <Info>
  Använd denna hanterare för att ta emot och bearbeta Dodo Payments webhook-händelser säkert i din Tanstack-app.
  </Info>
  <CodeGroup>
...
Kassa-sessioner erbjuder en säkrare, värd kassaupplevelse som hanterar hela betalningsflödet för både engångsköp och prenumerationer med full anpassningskontroll.
