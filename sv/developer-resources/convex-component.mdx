...
Ställ in miljövariabler i din Convex-instrumentpanel (**Inställningar** → **Miljövariabler**). Du kan komma åt instrumentpanelen genom att köra:
...
<Warning>
Innan du använder denna fråga, se till att definiera den lämpliga schemat i din `convex/schema.ts` fil eller ändra frågan för att matcha ditt befintliga schema.
</Warning>
...
<Tab title="Kundportal Inställning">
  <Info>
...
<Tab title="Webhook Hanterare Inställning">
  <Info>
...
<Info>
Kunden identifieras automatiskt med `identify` funktionen som är konfigurerad i din DodoPayments-inställning. Denna funktion bör returnera kundens `dodoCustomerId`.
</Info>
