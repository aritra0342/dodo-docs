...
<Accordion title="Begäran Kropp Parametrar">
  ...
  <ParamField body="on_demand.product_price" type="integer">
    Initial avgiftsbelopp (i den minsta valutaenheten). Om angivet, åsidosätter detta värde produktens ursprungliga pris som ställts in vid produktens skapande. Om utelämnat används produktens lagrade pris. Exempel: för att ta betalt $1.00, skicka <code>100</code>.
  </ParamField>
...
<AccordionGroup>
  <Accordion title="Avgiftsbegäran kropp parametrar">
    <ParamField body="product_price" type="integer" required>
      Belopp att ta betalt (i den minsta valutaenheten). Exempel: för att ta betalt $25.00, skicka <code>2500</code>.
    </ParamField>
...
Implementera webhookhantering för att spåra kundresan. Se [Implementera Webhooks](/developer-resources/integration-guide#implementing-webhooks).
