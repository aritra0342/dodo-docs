...
<CardGroup cols={2}>
<Card title="Snabbstart" icon="rocket" href="#integration-workflow">
  Få din mobilbetalningsintegration att fungera på 4 enkla steg
</Card>

<Card title="Plattforms exempel" icon="code" href="#platform-specific-integration">
...
<Steps>
<Step title="Backend: Skapa kassa-session">
<Card title="Kassa-session API-dokumentation" icon="book" href="/developer-resources/checkout-session">
Lär dig hur du skapar en kassa-session i din backend med Node.js, Python och mer. Se fullständiga exempel och parameterreferenser i den dedikerade <strong>Kassa-session API</strong> dokumentationen.
</Card>
<Note>
...
<Step title="Mobil: Öppna kassa i webbläsare">
Öppna kassa-URL:en i en säker in-app webbläsare för betalningsbehandling.

<Card 
  title="Se plattformspecifika integrations exempel" 
  icon="box" 
...
<Step title="Backend: Hantera betalningsslutförande">
...
Lägg till detta beroende i din `package.json`:
...
<Warning>
**Regional efterlevnad**: In-app betalnings-SDK:er har regionala begränsningar. På **iOS** är inbyggda betalnings-SDK:er endast lagliga i **EU** (under DMA-villkor). På **Android** är de lagliga i marknader med User Choice Billing (UCB). För andra regioner, använd kassa-länkarna ovan för att säkerställa efterlevnad av App Store och Play Store.
</Warning>

<Card 
  title="React Native SDK Integrationsguide" 
  icon="mobile-screen" 
  href="/developer-resources/react-native-integration"
>
  Fullständig guide för att integrera Dodos React Native SDK med inbyggda betalningsblad, fullständiga anpassningsalternativ och direkt betalningshantering. Inkluderar installations-, implementations- och testningsanvisningar.
</Card>

<Info>
Granska [App Store Avgiftsbypassguide](/features/bypassing-app-store-fees) för att förstå regionala efterlevnadskrav för in-app betalningsintegrationer.
</Info>
...
<Tip>
Använd WebView för betalningslänkar. Hantera omdirigerings-URL:en för att upptäcka betalningsslutförande.
</Tip>
