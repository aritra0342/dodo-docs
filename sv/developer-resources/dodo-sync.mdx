...
**PostgreSQL**: Tabeller (`Subscriptions`, `Payments`, `Licenses`, `Customers`) kommer att skapas i den databas som anges i din anslutnings-URI. Data lagras som JSONB.

**MySQL**: Tabeller (`Subscriptions`, `Payments`, `Licenses`, `Customers`) kommer att skapas i den databas som anges i din anslutnings-URI. Data lagras som JSON.
