...
<Tab title="Webhook Hanterare">
  <Info>
  Använd denna hanterare för att ta emot och bearbeta Dodo Payments webhook-händelser säkert i din Express-app.
  </Info>
  <CodeGroup> 
...
Specificera betalningsvaluta (t.ex. <code>USD</code>).
</ParamField>
<ParamField query="showCurrencySelector" type="boolean">
Visa valutaväljare.
</ParamField>
<ParamField query="paymentAmount" type="integer">
Specificera betalningsbelopp (t.ex. <code>1000</code> för $10.00).
</ParamField>
...
Om det är inställt på <code>true</code>, skickar ett e-postmeddelande till kunden med portalens länk.
</ParamField>
