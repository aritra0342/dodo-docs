...
4. **Loggar händelsen** - Lagrar rå webhook i `webhook_events` tabell för revisionsspår
5. **Behandlar händelsen** - Skapar eller uppdaterar kunder och prenumerationer i Neon
6. **Hanterar fel** - Loggar misslyckanden och markerar händelsen som obehandlad för försök igen
