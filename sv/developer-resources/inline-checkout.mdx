...
<Info>
För implementationer av mörkt läge rekommenderas det att använda `#0d0d0d` som bakgrundsfärg för optimal visuell integration med inline-kassaramen.
</Info>

## Felsökning

<AccordionGroup>
<Accordion title="Kassaramen visas inte">
