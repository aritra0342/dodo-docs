...
- Se till att checkout-URL:n är giltig och från create checkout session API
...
Apple Pay gör det möjligt för kunder att slutföra betalningar snabbt och säkert med sina sparade betalningsmetoder. När det är aktiverat kan kunder starta Apple Pay-modalen direkt från checkout-overlay på stödda enheter.
...
<Step title="Begär Apple Pay-aktivering">
...
Efter att ha fått bekräftelse, testa Apple Pay i din checkout:

1. Öppna din checkout på en stödd enhet (iOS 17+, iPadOS 17+ eller Safari 17+ på macOS)
...
<Tip>
Använd **overlay checkout** för snabbare integration med minimala ändringar i dina befintliga sidor. Använd **inline checkout** när du vill ha maximal kontroll över checkout-upplevelsen och sömlös branding.
</Tip>
...
<Card title="Inline Checkout" icon="credit-card" href="/developer-resources/inline-checkout">
    Bädda in checkout direkt i din sida för helt integrerade upplevelser.
</Card>
