...
description: Lär dig hur du integrerar Dodo Payments med ditt SveleteKit App
  Router-projekt med hjälp av vår SveleteKit Adaptor. Täcker kassa, kundportal,
...
<Card title="Kassa Hanterare" icon="cart-shopping" href="#checkout-route-handler">
    Integrera Dodo Payments kassa i din SveleteKit-app.
</Card>
...
<Info>
Alla exempel förutsätter att du använder SveleteKit App Router.
</Info>

<Tabs>
<Tab title="Kassa Hanterare">
  <Info>
  Använd denna hanterare för att integrera Dodo Payments kassa i din SveleteKit-app. Stöder statiska (GET), dynamiska (POST) och sessions (POST) betalningsflöden.
  </Info>
  <CodeGroup>
...
<Tab title="Webhook Hanterare">
  <Info>
  Använd denna hanterare för att ta emot och bearbeta Dodo Payments webhook-händelser säkert i din SveleteKit-app.
  </Info>
  <CodeGroup>
...
Kundportal Routhanteraren gör det möjligt för dig att sömlöst integrera Dodo Payments kundportal i din SveleteKit-applikation.
