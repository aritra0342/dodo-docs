...
<Info>
SDK:n stöder Go 1.18 och senare versioner, och utnyttjar moderna Go-funktioner för optimal prestanda.
</Info>
...
<Warning>
Förvara alltid dina API-nycklar säkert med hjälp av miljövariabler. Hårdkoda dem aldrig i din källkod.
</Warning>
...
<Card title="Kontextstöd" icon="clock">
  Fullt stöd för context.Context för avbokningar och tidsgränser
</Card>
...
Utnyttja Gos kontext för tidsgränser och avbokningar:
...
### Återförsäljningskonfiguration

Konfigurera automatisk återförsäljning:
...
- **GitHub**: Öppna ett problem på [repo](https://github.com/dodopayments/dodopayments-go)
