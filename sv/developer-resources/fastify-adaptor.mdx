...
<Tab title="Kassa Hanterare">
  <Info>
  Använd denna hanterare för att integrera Dodo Payments kassa i din Fastify-app. Stöder statiska (GET), dynamiska (POST) och sessions (POST) betalningsflöden.
  </Info>
  <CodeGroup>
...
<Tab title="Webhook Hanterare">
  <Info>
  Använd denna hanterare för att ta emot och bearbeta Dodo Payments webhook-händelser säkert i din Fastify-app.
  </Info>
  <CodeGroup>
...
Kassa sessioner ger en mer säker, värd kassaupplevelse som hanterar hela betalningsflödet för både engångsköp och prenumerationer med full anpassningskontroll.
