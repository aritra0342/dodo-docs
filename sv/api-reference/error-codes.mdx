...
- `LINE_ITEM_FULLY_REFUNDED`
  ...
  - **Message:** Radpost {id} har blivit helt återbetald och kan inte återbetalas ytterligare.
...
- `LINE_ITEM_REFUND_AMOUNT_TOO_HIGH`
  ...
  - **Message:** Radpost {id} begärda återbetalningsbelopp inklusive skatt är {amount} vilket är över det betalda beloppet {amount}
...
- `REFUND_WINDOW_EXPIRED`
  ...
  - **Message:** Återbetalningar kan inte initieras {days} dagar efter betalningens skapelse. Kontakta support@dodopayments.com.
