...
5. **Webhook-verifiering i alla SDK:er**  
   Alla SDK:er inkluderar nu inbyggda webhook-verifieringsfunktioner för att säkert validera inkommande webhook-händelser. Drivs av det branschstandardiserade [webhooks-biblioteket](https://github.com/standard-webhooks), gör dessa funktioner det enkelt att verifiera och bearbeta webhook-payloads.
