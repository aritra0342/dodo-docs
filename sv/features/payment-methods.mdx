...
<Note>
Klarna och Afterpay kräver ett minimibelopp på <strong>50,01 USD</strong> (eller motsvarande i stödda valutor) för berättigande vid kassan. Transaktioner under denna gräns kommer inte att vara berättigade för dessa BNPL-betalningsalternativ. 
...
**Lösning:** Övervaka webhook-händelser för mandatavbokningar och betalningsmisslyckanden. Implementera återförsökslogik eller be kunder att återetablera sin betalningsmetod.

**Betalningsavdrag försenat:**
