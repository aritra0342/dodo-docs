...
<Step title="Aktivera konverteringsspårning i Dub">
  ...
  <Info>
  Lär dig mer om att aktivera konverteringsspårning i [Dub-dokumentationen](https://dub.co/docs/conversions/quickstart).
  </Info>
</Step>
...
När du skapar en kassa-session, fånga Dub klick-ID från cookien och inkludera det i din betalningsmetadata tillsammans med kundens externa ID.
...
Skicka endast beloppet före skatt till Dub för noggrann intäktsövervakning:
...
<Tip>
**Fånga klick-ID tidigt**: Lagra Dub klick-ID så tidigt som möjligt i din kassa-flöde för att säkerställa noggrann attribuering, även om användaren navigerar bort och återvänder senare.
</Tip>
...
- Kontrollera att klick-ID matchar mellan skapande av kassa och slutförande av betalning
...
<Accordion title="Duplicerade försäljningar spåras">
...
<CardGroup cols={2}>
<Card title="Dub Konverteringsdokumentation" icon="book" href="https://dub.co/docs/conversions/quickstart">
