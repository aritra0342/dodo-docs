...
<Step title="Öppna Webhook-sektionen">
  ...
  <Frame>
    <img src="/images/integrations/teams.png" alt="Lägg till slutpunkt och integrationsrullgardinsmeny" />
  </Frame>
</Step>

<Step title="Välj Microsoft Teams">
  Välj <b>Microsoft Teams</b> integrationskortet.
</Step>

<Step title="Skapa Teams Webhook">
...
<AccordionGroup>
<Accordion title="Inga meddelanden i Teams">
...
<Accordion title="Problem med kortformatering">
- Validera Adaptive Card-schema i Teams webhook-testare
- Kontrollera att alla obligatoriska fält är närvarande
- Se till att färgvärdena är giltiga (Bra, Varning, Uppmärksamhet, Standard)
</Accordion>
</AccordionGroup>