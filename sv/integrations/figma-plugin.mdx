...
Klona [dodopayments-figma-repositoriet](https://github.com/dodopayments/dodopayments-figma) och uppdatera dess `manifest.json` med namnet och ID:t från din genererade pluginmapp.
