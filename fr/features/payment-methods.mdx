...
<Note>
<strong>Méthodes de Paiement Indiennes :</strong> Les abonnements UPI et Rupay sont supportés avec des mandats conformes à la RBI. Consultez la section <a href="/features/subscription#subscriptions-with-rbi-compliant-mandates">Abonnement avec Mandats Conformes à la RBI</a> pour des détails importants sur les limites de mandat et les délais de traitement.
</Note>
...
<Accordion title="Problèmes d'abonnement aux méthodes de paiement indiennes">
**Échec de la facturation de l'abonnement après mise à niveau/diminution :**
- Le nouveau montant de facturation peut dépasser la limite de mandat existante (seuil de 15 000 Rs)
...
**Abonnement en attente après initiation de la facturation :**
- Le client peut avoir annulé le mandat pendant la fenêtre de traitement de 48 heures
- Le client peut avoir échoué à autoriser une facturation de grande valeur (≥15 000 Rs)
...
<Card title="Référence API pour Mettre à Jour la Méthode de Paiement" icon="code" href="/api-reference/subscriptions/update-payment-method">
