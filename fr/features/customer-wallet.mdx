...
<CardGroup cols={3}>
<Card title="Obtenir des Portefeuilles Clients" icon="code" href="/api-reference/customers/get-customer-wallets">
...
<Info>
Actuellement, seuls les soldes en <strong>USD</strong> et <strong>INR</strong> sont disponibles. D'autres devises arriveront bientôt.
</Info>
