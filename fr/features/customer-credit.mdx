...
<Step title="Accéder au Grand Livre de Crédit">
...
Suivez le même chemin de navigation : **Clients** → **Page de Détails du Client** → **Grand Livre de Crédit** → **Appliquer Crédit**.
</Step>
