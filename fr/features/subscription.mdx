...
## Abonnements avec Mandats Conformes à la RBI
  ...
  - **Frais inférieurs à 15 000 Rs :** Nous créons un mandat à la demande pour 15 000 INR. Le montant de l'abonnement est facturé périodiquement selon votre fréquence d'abonnement, jusqu'à la limite du mandat.
  - **Frais de 15 000 Rs ou plus :** Nous créons un mandat d'abonnement (ou mandat à la demande) pour le montant exact de l'abonnement.
  ...
  **Important :** Lors de la mise à niveau ou de la rétrogradation des abonnements, considérez attentivement les limites de mandat :
  ...
  - Si une mise à niveau/diminution entraîne un montant de frais qui dépasse 15 000 Rs et dépasse la limite de paiement à la demande existante, les frais de transaction peuvent échouer.
