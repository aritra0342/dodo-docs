...
<Step title="Terminé !">
  🎉 Les événements de paiement déclencheront désormais les automatisations d'e-mails de Customer.io.
</Step>
</Steps>
...
<AccordionGroup>
<Accordion title="Événements ne déclenchant pas de campagnes">
