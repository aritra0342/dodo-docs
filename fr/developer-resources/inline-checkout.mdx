...
- Vérifiez que l'URL de session de paiement `checkoutUrl` est valide.
</Accordion>
...
<Tip>
Utilisez le **paiement en ligne** lorsque vous souhaitez un contrôle maximal sur l'expérience de paiement et une marque intégrée. Utilisez le **paiement en superposition** pour une intégration plus rapide avec des modifications minimales de vos pages existantes.
</Tip>
