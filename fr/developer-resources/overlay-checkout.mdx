...
Le SDK fournit des informations détaillées sur les erreurs via le système d'événements. Implémentez toujours une gestion appropriée des erreurs dans votre fonction de rappel `onEvent` :
...
2. **Gestion des erreurs** : Implémentez toujours une gestion appropriée des erreurs dans votre fonction de rappel d'événements
...
| Fonctionnalité | Paiement en overlay | Paiement en ligne |
|---------|-----------------|-----------------|
...
<Tip>
Utilisez **le paiement en overlay** pour une intégration plus rapide avec des modifications minimales de vos pages existantes. Utilisez **le paiement en ligne** lorsque vous souhaitez un contrôle maximal sur l'expérience de paiement et un branding transparent.
</Tip>

## Ressources connexes

<CardGroup cols={2}>
<Card title="Paiement en ligne" icon="credit-card" href="/developer-resources/inline-checkout">
