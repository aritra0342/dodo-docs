...
Ajoutez-les à votre fichier <code>.env</code> :
...
Générez un secret de webhook pour votre URL de point de terminaison (par exemple, <code>https://&lt;votre-domaine&gt;/api/auth/dodopayments/webhooks</code>) dans le tableau de bord Dodo Payments et définissez-le dans votre fichier <code>.env</code> :
...
<AccordionGroup>
  <Accordion title="Problèmes courants">
    ...
    <b>Mismatch de signature du webhook</b> : Assurez-vous que le secret du webhook correspond à celui
