...
3. Voir les journaux en temps réel et l'historique des invocations
...
| Problème | Solution |
|-------|----------|
| Vérification échouée | Vérifiez que la clé de webhook est correcte dans le tableau de bord DodoPayments |
