...
Crea tu propio proyecto de plugin de Figma utilizando [la guía de inicio rápido de plugins de Figma](https://www.figma.com/plugin-docs/plugin-quickstart-guide/). Esto generará un andamiaje con un `manifest.json` archivo.
...
3. Sigue [las pautas de publicación de plugins de Figma](https://www.figma.com/plugin-docs/publishing-plugins/)
