...
<AccordionGroup>
<Accordion title="Pago no se abre">
...
## Checkout en Overlay vs Inline

Elige el tipo de checkout adecuado para tu caso de uso:

| Característica | Checkout en Overlay | Checkout Inline |
|----------------|--------------------|-----------------|
...
<Tip>
Usa **checkout en overlay** para una integración más rápida con cambios mínimos en tus páginas existentes. Usa **checkout inline** cuando desees el máximo control sobre la experiencia de checkout y un branding sin fisuras.
</Tip>
...
<Card title="Checkout Inline" icon="credit-card" href="/developer-resources/inline-checkout">
    Integra el checkout directamente en tu página para experiencias totalmente integradas.
</Card>
