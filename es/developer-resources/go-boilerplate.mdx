...
Actualiza la URL del webhook en tu [panel de Dodo](https://app.dodopayments.com/developer/webhooks) a la URL de ngrok. Asegúrate de actualizar tu archivo `.env` con la clave de verificación de webhook correcta.
</Accordion>
