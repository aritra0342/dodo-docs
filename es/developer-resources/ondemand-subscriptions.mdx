...
<Info>
Las suscripciones bajo demanda ya están disponibles para todas las empresas. Esta función permite un control de facturación flexible para servicios basados en el uso y medidos.
</Info>
...
<Accordion title="Parámetros del cuerpo de la solicitud">
  ...
  <ParamField body="return_url" type="string">
    Dónde redirigir al cliente después de completar el checkout alojado.
  </ParamField>
...
<Warning>
Cargar una suscripción que no es bajo demanda puede fallar. Asegúrate de que la suscripción tenga `on_demand: true` en sus detalles antes de cargar.
</Warning>
...
- Limita los reintentos concurrentes por cliente y por cuenta para evitar aumentos accidentales.
