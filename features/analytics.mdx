...
<Card title="Google Analytics 4" icon="chart-simple">
  Track page views, e-commerce events, and customer behavior with GA4's powerful analytics platform.
</Card>

<Card title="Google Tag Manager" icon="tags">
  Manage all your marketing tags in one place and deploy custom tracking without code changes.
</Card>

<Card title="Meta Pixel" icon="meta">
  Measure the effectiveness of your Facebook and Instagram ad campaigns with conversion tracking.
</Card>
</CardGroup>
