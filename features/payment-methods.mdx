...
| **Billie**               | Global               | GBP                  | No                   |

<Warning>
**PayPal Support Paused:** PayPal payment method support has been temporarily paused. PayPal is currently not available for new transactions. We'll update this page when PayPal support is restored.
</Warning>
...
<Accordion title="Digital Wallets">
  ...
  - **PayPal** – Global payments in EUR and GBP (not available for subscriptions). <strong>Note: PayPal support is currently paused.</strong>
...
<Accordion title="UK Payment Methods">
  Accept popular payment options for GBP transactions:

  - **RevolutPay** – Fast and seamless payments for Revolut users globally (one-time payments only)
  - **Billie** – B2B Buy Now Pay Later solution enabling businesses to offer flexible payment terms to their customers (one-time payments only)
