...
<Note>
프랑스의 사용자에게 디지털 구독을 판매한다고 상상해 보세요. Dodo Payments와 함께 우리는 결제를 수집하고, 프랑스 당국에 VAT를 신고하며, 귀하에게 순수익을 송금합니다. 세금 문제 없음. 변호사 없음. 오직 성장만 있습니다.
</Note>
...
<Tip>
"Payment Gateway를 터널로 생각해 보세요. 이제 Merchant of Record를 터널, 기차, 운전사 및 발권 직원이 모두 포함된 것으로 상상해 보세요."
</Tip>
...
<Note>
많은 스타트업의 경우 초기에는 게이트웨이를 사용하는 것이 충분할 수 있지만, 복잡성이 증가함에 따라 MoR로 전환하면 시간을 절약하고 리스크를 줄이며 국제 성장을 가속화할 수 있습니다.
</Note>
...
<CardGroup cols={2}>
<Card title="적응형 통화 지원" icon="money-bill-wave" href="/features/adaptive-currency">
Dodo가 고객의 현지 통화로 가격을 자동으로 제시하는 방법을 알아보세요
</Card>

<Card title="지원되는 결제 방법" icon="credit-card" href="/features/payment-methods">
Dodo Payments를 통해 제공되는 30개 이상의 결제 방법을 알아보세요
</Card>
</CardGroup>
...
<CardGroup cols={2}>
<Card title="무료 가입" icon="user-plus" href="https://app.dodopayments.com/signup">
Dodo Payments 계정을 만들고 오늘 글로벌 판매를 시작하세요
</Card>

<Card title="영업팀에 문의" icon="envelope" href="mailto:founders@dodopayments.com">
우리 팀으로부터 개인화된 안내를 받으세요
</Card>
</CardGroup>

<Tip>
Dodo가 어려운 일을 처리하게 하세요 - 그러면 귀하는 훌륭한 제품을 만드는 데 집중할 수 있습니다.
</Tip>