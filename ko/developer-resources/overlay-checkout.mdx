...
| 브랜딩 | 페이지와 분리 | 매끄럽게 |
| 구현 노력 | 낮음 | 높음 |
| 최적의 사용 | 빠른 통합, 기존 페이지 | 맞춤 체크아웃 페이지, 높은 전환 흐름 |

<Tip>
기존 페이지에 최소한의 변경으로 빠른 통합을 원한다면 **오버레이 체크아웃**을 사용하세요. 체크아웃 경험과 매끄러운 브랜딩에 대한 최대한의 제어를 원한다면 **인라인 체크아웃**을 사용하세요.
</Tip>
...
<Card title="인라인 체크아웃" icon="credit-card" href="/developer-resources/inline-checkout">
    페이지에 체크아웃을 직접 내장하여 완전히 통합된 경험을 제공합니다.
</Card>
...
<Card title="통합 가이드" icon="book" href="/developer-resources/integration-guide">
    Dodo Payments 통합에 대한 완벽한 가이드입니다.
</Card>
</CardGroup>
