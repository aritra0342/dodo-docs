---
title: SveleteKit 어댑터
description: Dodo Payments를 SveleteKit App Router 프로젝트에 통합하는 방법을 배우세요. 체크아웃, 고객
...
<Card title="체크아웃 핸들러" icon="cart-shopping" href="#checkout-route-handler">
    Dodo Payments 체크아웃을 SveleteKit 앱에 통합하세요.
</Card>
...
<Info>
모든 예제는 SveleteKit App Router를 사용한다고 가정합니다.
</Info>

<Tabs>
<Tab title="체크아웃 핸들러">
  <Info>
  이 핸들러를 사용하여 Dodo Payments 체크아웃을 SveleteKit 앱에 통합하세요. 정적 (GET), 동적 (POST), 세션 (POST) 결제 흐름을 지원합니다.
  </Info>
  <CodeGroup>
...
고객 포털 라우트 핸들러를 사용하면 Dodo Payments 고객 포털을 SveleteKit 애플리케이션에 원활하게 통합할 수 있습니다.
