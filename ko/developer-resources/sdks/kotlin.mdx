...
<Info>
SDK는 Kotlin 1.6 이상이 필요하며 JVM 및 Android 플랫폼과 호환됩니다.
</Info>
...
<Tip>
Kotlin의 `runCatching`을 사용하여 결과 타입으로 오류 처리를 보다 함수적으로 접근하세요.
</Tip>
