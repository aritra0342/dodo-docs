...
<Note>
Dodo Payments PHP API 라이브러리는 현재 **베타** 상태입니다. 여러분이 실험해 보시기를 기대합니다! [문제 제기하기](https://github.com/dodopayments/dodopayments-php/issues)를 통해 제안, 버그 보고 또는 기능 요청을 공유해 주세요.
</Note>
...
`config/services.php`에 구성을 추가하세요:
