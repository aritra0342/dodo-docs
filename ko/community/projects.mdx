...
<Tab title="라이브러리 및 SDK">
  <CardGroup cols={1}>
    <Card title="dodopayments-webhooks (TypeScript)" href="https://github.com/sancho1952007/dodopayments-webhooks" icon="node-js">
      ...
      <br/>Express, Hono, Elysia 등을 위한 서명 검증 및 타입이 지정된 이벤트 핸들링 포함.
    ...
    <Card title="dodpayments_rust_sdk (Rust)" href="https://github.com/Muhammad-Owais-Warsi/dodpayments_rust_sdk" icon="rust">
      ...
      <br/>Rust 서비스에서 핵심 엔드포인트를 호출하기 위한 타입이 지정된 모델 및 헬퍼 제공.
...
<Card title="multi-app-dodo-payments (Python)" href="https://github.com/aniketkarne/multi-app-dodo-payments" icon="python">
      ...
      <br/>Dodo Payments를 사용하여 여러 애플리케이션의 결제를 처리하는 프로덕션 준비 완료 결제 마이크로서비스로, FastAPI로 구축되었습니다. 
...
<Tab title="보일러플레이트 및 스타터">
  <CardGroup cols={1}>
    ...
    <Card title="DodoStarter 보일러플레이트" href="https://github.com/AINotSoSmart/dodostarter" icon="rocket">
      ...
      <br/>빈 폴더에서 작업 중인 앱으로 오후에 전환할 수 있습니다.
