...
<Step title="웹훅 섹션 열기">
  ...
  <Frame>
    <img src="/images/integrations/customer-io.png" alt="Add Endpoint 및 통합 드롭다운" />
  </Frame>
</Step>

<Step title="Customer.io 선택">
  <b>Customer.io</b> 통합 카드를 선택합니다.
</Step>
...
<AccordionGroup>
<Accordion title="이벤트가 캠페인을 트리거하지 않음">
