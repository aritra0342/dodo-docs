...
- **개인화를 위한 동적 데이터 사용**: `dynamicData` 필드를 사용하여 고객의 이름, 결제 금액 및 구독 세부정보와 같은 고객별 정보를 포함하여 이메일을 개인화하세요. 개인화된 이메일은 더 높은 참여율을 보입니다.
...
- 템플릿 ID가 AutoSend에서 올바르고 활성 상태인지 확인
