...
<Step title="DataFast 스크립트 설치">
  ...
  플랫폼에 맞는 설치 지침은 [DataFast 문서](https://datafa.st/docs)를 방문하세요.
</Step>
...
- `datafast_visitor_id`가 결제 메타데이터에 캡처되고 저장되고 있는지 확인하세요.
...
- 추가 지침을 위해 DataFast의 [결제 API 문서](https://datafa.st/docs/payments-api)를 검토하세요.
</Accordion>
