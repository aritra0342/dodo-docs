---
title: v1.70.0 (December 23, 2025)
description: "Use existing payment methods for instant checkouts, manage subscription plans from dashboard, generate short payment links, skip success pages with redirect_immediately, and enable on-demand subscriptions for all businesses"
icon: "link"
---
...
2. **Subscription Plan Changes in Dashboard with Next Billing Date Updates**  
