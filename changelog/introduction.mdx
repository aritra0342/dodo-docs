...
|---------|--------------|------------|
| [v1.84.0](/changelog/v1.84.0) | February 20, 2026 | Verifi RDR dispute prevention, DodoPayments CLI, customer portal UI revamp, inline checkout payment method updates, Tax ID prefill for checkout sessions, license_key and email in return URL, customer email update API, and Bun adapter |
