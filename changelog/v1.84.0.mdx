...
description: "Verifi RDR dispute prevention, DodoPayments CLI, customer portal UI revamp, inline checkout payment method updates, Tax ID prefill, return URL query params, customer email update API, and Bun adapter"
icon: "arrows-turn-right"
---

## New Features

### 1. **Verifi RDR Support on Dodo Payments**
...
### 4. **Update Payment Method in Inline Checkout**
...
### 5. **Tax ID Prefill Support for Checkout Sessions**
...
### 6. **License Key and Email in Return URL Redirect**
