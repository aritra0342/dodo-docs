...
Customize checkout appearance via the `theme_config` parameter when creating checkout sessions. Configure colors, fonts, border radius, and button text for both light and dark modes.
