...
Database type to use. Supported values: `"mongodb"` or `"postgres"`.
</ParamField>

<ParamField path="--database-uri" type="string" alias="-u" required>
Connection URI for your database. For MongoDB, use a MongoDB connection string (e.g., `mongodb://localhost:27017` or `mongodb+srv://user:pass@cluster.mongodb.net/`). For PostgreSQL, use a PostgreSQL connection string (e.g., `postgresql://user:password@localhost:5432/mydb`).
</ParamField>
...
Name of the database to use. Supported values: `"mongodb"` or `"postgres"`.
</ParamField>

<ParamField body="databaseURI" type="string" required>
Connection string for your database. For MongoDB, provide a valid MongoDB connection URI. For PostgreSQL, provide a valid PostgreSQL connection URI (e.g., `postgresql://user:password@localhost:5432/mydb`).
</ParamField>
