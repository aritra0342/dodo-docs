...
<Frame>
  <img
    src="/images/sentra/poster.png"
    alt="Sentra welcome screen showing setup interface"
  />
</Frame>
...
<Card title="Learn how to create and manage API keys" icon="key" href="/guides/api-key-generation">
