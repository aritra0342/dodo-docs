...
<CardGroup cols={3}>
<Card title="顧客ウォレットを取得" icon="code" href="/api-reference/customers/get-customer-wallets">
  顧客のウォレット残高を通貨ごとに確認します。
</Card>

<Card title="元帳エントリを作成" icon="plus" href="/api-reference/customers/post-customer-wallets-ledger-entries">
...
<Card title="顧客ウォレット残高を取得" icon="wallet" href="/api-reference/customers/get-customer-wallets">
...
<Card title="顧客ウォレット元帳エントリを作成" icon="plus" href="/api-reference/customers/post-customer-wallets-ledger-entries">
