...
Python SDKは、Dodo Payments APIへのPythonicインターフェースを提供し、リクエストとレスポンスの型定義を持つ同期および非同期クライアントを提供します。Python 3.7以上をサポートし、包括的なテストカバレッジが含まれています。
...
<Info>
SDKはPython 3.7以上が必要です。最良の体験とセキュリティ更新のために、最新の安定版Pythonの使用をお勧めします。
</Info>
