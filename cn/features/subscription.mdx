...
<Card title="预览变更计划 API" icon="eye" href="/api-reference/subscriptions/preview-change-plan">
  在提交之前预览计划变更。
</Card>
...
UPI 和印度卡订阅在 RBI（印度储备银行）法规下运营，具有特定的授权要求：
  ...
  - **收费低于 Rs 15,000：** 我们为 Rs 15,000 INR 创建一个按需授权。订阅金额根据您的订阅频率定期收费，最高不超过授权限制。
  - **收费 Rs 15,000 或以上：** 我们为确切的订阅金额创建一个订阅授权（或按需授权）。

  - **低于 15,000 卢比的费用：** 我们为 15,000 印度卢比创建一个按需授权。订阅金额根据您的订阅频率定期收取，直到达到授权限额。
  - **15,000 卢比或以上的费用：** 我们为确切的订阅金额创建一个订阅授权（或按需授权）。

  **重要：** 在升级或降级订阅时，请仔细考虑授权限制：

  - 如果升级/降级导致收费金额超过 Rs 15,000 并超出现有的按需付款限制，则交易收费可能会失败。
  - 在这种情况下，客户可能需要更新其付款方式或再次更改订阅以建立具有正确限制的新授权。

  - 如果升级/降级导致的费用超过 15,000 卢比并超出现有的按需支付限额，则交易费用可能会失败。
  - 在这种情况下，客户可能需要更新其支付方式或再次更改订阅，以建立具有正确限额的新授权。

  对于 Rs 15,000 或以上的订阅收费：

  对于 15,000 卢比或以上的订阅费用：
