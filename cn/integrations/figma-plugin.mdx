...
<Step title="克隆示例实现">
克隆 [dodopayments-figma 仓库](https://github.com/dodopayments/dodopayments-figma)，并用您生成的插件文件夹中的名称和 ID 更新其 `manifest.json`。
...
- 更新 `Authenticated.tsx` 以向具有有效许可证密钥的用户公开功能
...
<Tip>
仅在您准备好生产并在测试模式下彻底测试后，才切换到 `live_mode`。
</Tip>
</Step>
</Steps>
