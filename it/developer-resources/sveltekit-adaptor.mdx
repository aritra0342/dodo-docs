...
description: Scopri come integrare Dodo Payments con il tuo progetto SveleteKit
  App Router utilizzando il nostro SveleteKit Adaptor. Copre checkout, portale
...
<Card title="Gestore Checkout" icon="cart-shopping" href="#checkout-route-handler">
    Integra il checkout di Dodo Payments nella tua app SveleteKit.
</Card>
...
<Info>
Tutti gli esempi presuppongono che tu stia utilizzando il SveleteKit App Router.
</Info>

<Tabs>
<Tab title="Gestore Checkout">
  <Info>
  Usa questo gestore per integrare il checkout di Dodo Payments nella tua app SveleteKit. Supporta flussi di pagamento statici (GET), dinamici (POST) e di sessione (POST).
  </Info>
  <CodeGroup>
...
<Tab title="Gestore Webhook">
  <Info>
  Usa questo gestore per ricevere e gestire in modo sicuro gli eventi webhook di Dodo Payments nella tua app SveleteKit.
  </Info>
  <CodeGroup>
...
Il Gestore Route Portale Clienti ti consente di integrare senza soluzione di continuità il portale clienti di Dodo Payments nella tua applicazione SveleteKit.
