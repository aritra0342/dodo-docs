...
<Card title="Gestore Checkout" icon="cart-shopping" href="#checkout-route-handler">
    Integra il checkout di Dodo Payments con flussi statici, dinamici e di sessione.
</Card>
...
<Info>
Tutti gli esempi presuppongono che tu stia utilizzando il Next.js App Router.
</Info>

<Tabs>
<Tab title="Gestore Checkout">
  <Info>
  Usa questo gestore per integrare il checkout di Dodo Payments nella tua app Next.js. Supporta flussi di pagamento statici (GET), dinamici (POST) e di sessione di checkout (POST).
  </Info>
  <CodeGroup>
...
<Tab title="Gestore Webhook">
  <Info>
  Usa questo gestore per ricevere e gestire eventi webhook di Dodo Payments in modo sicuro nella tua app Next.js.
  </Info>
  <CodeGroup>
