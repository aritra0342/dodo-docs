...
<Info>
L'SDK supporta Go 1.18 e versioni successive, sfruttando le funzionalità moderne di Go per prestazioni ottimali.
</Info>
...
<Warning>
Conserva sempre le tue chiavi API in modo sicuro utilizzando variabili d'ambiente. Non codificarle mai nel tuo codice sorgente.
</Warning>

## Caratteristiche Principali

<CardGroup cols={2}>
<Card title="Supporto per il Contesto" icon="clock">
  Supporto completo per context.Context per cancellazione e timeout
</Card>

<Card title="Tipizzazione Forte" icon="shield-check">
  Richieste e risposte fortemente tipizzate per sicurezza a tempo di compilazione
</Card>
