...
Il SDK Python offre un'interfaccia Pythonica per l'API Dodo Payments, fornendo sia client sincroni che asincroni con definizioni di tipo per richieste e risposte. Supporta Python 3.7+ e include una copertura di test completa.
...
<Info>
Il SDK richiede Python 3.7 o superiore. Ti consigliamo di utilizzare l'ultima versione stabile di Python per la migliore esperienza e aggiornamenti di sicurezza.
</Info>
