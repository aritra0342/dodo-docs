...
<Accordion title="Parametri del corpo della richiesta">
  ...
  <ParamField body="on_demand.product_price" type="integer">
    Importo dell'addebito iniziale (nell'unità monetaria più piccola). Se specificato, questo valore sovrascrive il prezzo originale del prodotto impostato durante la creazione del prodotto. Se omesso, viene utilizzato il prezzo memorizzato del prodotto. Esempio: per addebitare $1.00, passare <code>100</code>.
  </ParamField>
...
<AccordionGroup>
  <Accordion title="Parametri del corpo della richiesta di addebito">
    <ParamField body="product_price" type="integer" required>
      Importo da addebitare (nell'unità monetaria più piccola). Esempio: per addebitare $25.00, passare <code>2500</code>.
    </ParamField>
...
<Note>
Per un elenco completo delle motivazioni di rifiuto e se sono correggibili dall'utente, vedere la
