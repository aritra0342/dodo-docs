...
<Info>
Tutti gli esempi presuppongono che tu stia utilizzando il Tanstack App Router.
</Info>
...
<Tab title="Gestore Webhook">
  <Info>
  Usa questo gestore per ricevere e gestire eventi webhook di Dodo Payments in modo sicuro nella tua app Tanstack.
  </Info>
  <CodeGroup>
