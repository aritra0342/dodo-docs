...
<Note>
Apple Pay non è attualmente supportato nell'esperienza di checkout inline. Prevediamo di aggiungere supporto per Apple Pay in una futura versione.
</Note>
...
<Card title="Checkout Overlay" icon="layer-group" href="/developer-resources/overlay-checkout">
    Usa il checkout overlay per un'integrazione modale rapida.
</Card>
