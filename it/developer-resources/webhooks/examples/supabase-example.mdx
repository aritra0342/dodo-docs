...
4. Copia e incolla il contenuto completo di [`schema.sql`](#database-schema)
5. Esegui la query
...
1. Vai a [DodoPayments Dashboard](https://app.dodopayments.com) → Sviluppatore → Webhook
...
| Errore di verifica JWT | Distribuisci con il `--no-verify-jwt` flag |
