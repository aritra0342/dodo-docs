...
1. Vai su [Dashboard DodoPayments](https://app.dodopayments.com) → Sviluppatore → Webhook
...
| Worker non distribuito | Esegui `npm install`, controlla la sintassi di `wrangler.toml` |
