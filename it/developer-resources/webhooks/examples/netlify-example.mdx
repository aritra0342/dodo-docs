...
1. Vai al [Dashboard di DodoPayments](https://app.dodopayments.com) → Sviluppatore → Webhook
...
✅ **Idempotenza** - Previene l'elaborazione duplicata con ID webhook  
...
5. **Gestisce gli errori** - Registra i fallimenti e segna l'evento come non elaborato per il retry
...
| Variabili ambientali non disponibili | Imposta le variabili nella CLI o nel dashboard, quindi ridistribuisci |
