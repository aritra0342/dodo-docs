...
**Nome del Contatore**: Copia e incolla esattamente → `Image Generation Meter`

**Descrizione**: Copia questo → `Tracks each AI image generation request made by customers using our DALL-E powered service`

**Nome Evento**: Questo è cruciale - copia esattamente → `image.generated`
...
**Nome Prodotto**: Copia questo → `PixelGen AI - Image Generation`
