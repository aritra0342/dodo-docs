...
<Step title="Precompila le informazioni del cliente (opzionale)">
  ...
  <AccordionGroup>
    <Accordion title="Campi cliente supportati">
      - <ParamField query="fullName" type="string">Nome completo del cliente (ignorato se sono forniti firstName o lastName).</ParamField>
      ...
      - <ParamField query="zipCode" type="string">Codice postale.</ParamField>
...
<Step title="Aggiungi controlli avanzati (opzionale)">
  - <ParamField query="paymentCurrency" type="string">Specifica la valuta di pagamento. Per impostazione predefinita, è la valuta del paese di fatturazione.</ParamField>
...
- API per link di pagamento una tantum [Riferimento API](/api-reference/payments/post-payments)
- API per link di pagamento in abbonamento [Riferimento API](/api-reference/subscriptions/post-subscriptions)

La guida seguente è per la creazione di link di pagamento una tantum.
