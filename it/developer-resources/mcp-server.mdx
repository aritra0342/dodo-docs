...
<Tip>
Usa `@latest` per ottenere sempre l'ultima versione, o fissa a una versione specifica come `@1.0.0` per stabilità.
</Tip>
...
<Step title="Apri le impostazioni di Cursor">
    Naviga a **Impostazioni Cursor** > **Funzionalità** > **Protocollo di Contesto del Modello** o premi `Cmd/Ctrl + Shift + P` e cerca "Impostazioni MCP".
</Step>
...
<Steps>
<Step title="Apri impostazioni Cline">
...
Verifica che `DODO_PAYMENTS_ENVIRONMENT` sia impostata correttamente (`live_mode` per produzione).
