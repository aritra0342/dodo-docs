...
| Caratteristica | Overlay Checkout | Inline Checkout |
|----------------|------------------|-----------------|
| Profondità di integrazione | Modale sopra la pagina | Completamente integrato nella pagina |
| Controllo del layout | Limitato | Controllo totale |
...
<Tip>
Usa **overlay checkout** per un'integrazione più rapida con modifiche minime alle tue pagine esistenti. Usa **inline checkout** quando desideri il massimo controllo sull'esperienza di checkout e un branding senza soluzione di continuità.
</Tip>
...
Per ulteriore aiuto, visita la nostra [community di Discord](https://discord.gg/bYqAp4ayYh) o contatta il nostro team di supporto per sviluppatori.
