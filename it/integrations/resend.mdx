...
<Step title="Apri la Sezione Webhook">
  ...
  <Frame>
    <img src="/images/integrations/resend.png" alt="Aggiungi Endpoint e menu a discesa delle integrazioni" />
  </Frame>
</Step>

<Step title="Seleziona Resend">
  Scegli la scheda di integrazione <b>Resend</b>.
</Step>

<Step title="Inserisci la Chiave API">
  Fornisci la tua chiave API di Resend nella configurazione.
</Step>
...
<Step title="Fatto!">
  🎉 Gli eventi di pagamento attiveranno ora automaticamente email transazionali tramite Resend.
</Step>
</Steps>
...
- Controlla che il dominio del mittente sia verificato in Resend
- Assicurati che gli indirizzi email dei destinatari siano validi
- Rivedi i limiti e le quote di invio di Resend
</Accordion>

<Accordion title="Errori di trasformazione">
- Valida che la struttura JSON corrisponda al formato API di Resend
