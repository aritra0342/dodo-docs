...
<Step title="Apri la Sezione Webhook">
  ...
  <Frame>
    <img src="/images/integrations/sendgrid.png" alt="Aggiungi Endpoint e menu a discesa delle integrazioni" />
  </Frame>
</Step>

<Step title="Seleziona SendGrid">
...
<Step title="Testa & Crea">
  Testa con payload di esempio e clicca su <b>Crea</b> per attivare l'invio delle email.
</Step>
