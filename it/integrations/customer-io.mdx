...
<Step title="Apri la Sezione Webhook">
  ...
  <Frame>
    <img src="/images/integrations/customer-io.png" alt="Aggiungi Endpoint e menu a discesa delle integrazioni" />
  </Frame>
</Step>

<Step title="Seleziona Customer.io">
  Scegli la scheda di integrazione <b>Customer.io</b>.
</Step>
...
<AccordionGroup>
<Accordion title="Eventi che non attivano campagne">
...
- Valida che la struttura JSON corrisponda al formato API di Customer.io
- Controlla che tutti i campi richiesti siano presenti
- Assicurati che i nomi degli eventi e gli attributi siano formattati correttamente
</Accordion>
</AccordionGroup>