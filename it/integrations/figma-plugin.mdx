...
<Steps>
<Step title="Crea Plugin Base">
Crea il tuo progetto plugin Figma utilizzando la [guida rapida ai plugin di Figma](https://www.figma.com/plugin-docs/plugin-quickstart-guide/). Questo genererà uno scaffold con un file `manifest.json`.
...
Clona il [repository dodopayments-figma](https://github.com/dodopayments/dodopayments-figma) e aggiorna il suo `manifest.json` con il nome e l'ID dalla tua cartella plugin generata.
...
<Steps>
<Step title="Configura Accesso alla Rete">
...
<Step title="Configura Modalità API">
