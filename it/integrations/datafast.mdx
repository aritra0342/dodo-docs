...
<Accordion title="L'attribuzione del fatturato non funziona">
...
- Rivedi la [documentazione dell'API di pagamento di DataFast](https://datafa.st/docs/payments-api) per ulteriori indicazioni
</Accordion>
