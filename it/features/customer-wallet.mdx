...
<CardGroup cols={3}>
<Card title="Ottieni Portafogli Clienti" icon="code" href="/api-reference/customers/get-customer-wallets">
  Controlla i saldi dei portafogli clienti in diverse valute.
</Card>

<Card title="Crea Voce di Libro Mastro" icon="plus" href="/api-reference/customers/post-customer-wallets-ledger-entries">
  Aggiungi o rimuovi crediti dai portafogli clienti.
</Card>

<Card title="Elenca Voci di Libro Mastro" icon="list" href="/api-reference/customers/get-customer-wallets-ledger-entries">
...
<Frame>
  <img src="/images/customer/customer-wallet.png" alt="Portafogli Clienti" />
</Frame>
...
<Info>
Attualmente, sono disponibili solo saldi in <strong>USD</strong> e <strong>INR</strong>. Altre valute in arrivo presto.
</Info>
...
<Card title="Ottieni Saldi dei Portafogli Clienti" icon="wallet" href="/api-reference/customers/get-customer-wallets">
...
<Card title="Crea Voce di Libro Mastro Portafoglio Cliente" icon="plus" href="/api-reference/customers/post-customer-wallets-ledger-entries">
...
<Card title="Elenca Voci di Libro Mastro Portafoglio Cliente" icon="list" href="/api-reference/customers/get-customer-wallets-ledger-entries">
...
<Steps>
<Step title="Dai il Benvenuto ai Nuovi Clienti">
...
<Step title="Gestisci gli Acquisti di Crediti">
...
<AccordionGroup>
<Accordion title="Clienti Statunitensi">
...
<Accordion title="Clienti Indiani">
