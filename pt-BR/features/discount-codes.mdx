...
Verifique se um código é válido e aplicável antes de aplicar.
</Card>

<Card title="Criar Desconto (API)" icon="code" href="/api-reference/discounts/create-discount">
Crie novos códigos de desconto programaticamente.
</Card>
...
- **Ofertas de aquisição**: Incentivos para primeira compra ou recompensas de referência
...
- **Checkout integrado**: Campo de UI e suporte de API via sessões de checkout
...
Pré-aplique um desconto e mostre a UI de entrada do código.
