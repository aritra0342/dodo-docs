...
- A assinatura está em estado `on_hold` devido a falha no pagamento
...
Quando uma assinatura está em estado `on_hold` (devido a falha na renovação ou falha na cobrança de alteração de plano), atualizar o método de pagamento irá:
