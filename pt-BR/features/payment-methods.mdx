...
<Accordion title="Monitorar e otimizar">
...
<Accordion title="Problemas de assinatura do método de pagamento indiano">
**Falha na cobrança da assinatura após atualização/redução:**
...
**Solução:** Monitore eventos de webhook para cancelamentos de mandatos e falhas de pagamento. Implemente lógica de repetição ou solicite aos clientes que restabeleçam seu método de pagamento.
...
Quando uma assinatura está em estado `on_hold` (devido a falha de renovação ou falha de cobrança de alteração de plano), atualizar o método de pagamento irá:
