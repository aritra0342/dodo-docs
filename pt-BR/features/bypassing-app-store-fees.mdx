...
<CardGroup cols={2}>
<Card title="Comece" icon="rocket" href="/quickstart">
Comece sua integração com o Dodo Payments
</Card>

<Card title="Integração Móvel" icon="mobile" href="/developer-resources/mobile-integration">
Aprenda como integrar pagamentos em seu aplicativo móvel
</Card>
</CardGroup>
