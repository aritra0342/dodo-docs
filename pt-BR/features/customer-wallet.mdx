...
<CardGroup cols={3}>
<Card title="Obter Carteiras de Clientes" icon="code" href="/api-reference/customers/get-customer-wallets">
  Verifique os saldos das carteiras dos clientes em diferentes moedas.
</Card>

<Card title="Criar Lançamento no Livro" icon="plus" href="/api-reference/customers/post-customer-wallets-ledger-entries">
  Adicione ou remova créditos das carteiras dos clientes.
</Card>

<Card title="Listar Lançamentos no Livro" icon="list" href="/api-reference/customers/get-customer-wallets-ledger-entries">
...
<ResponseField name="Saldo em USD" type="integer">
Saldo em Dólares Americanos (armazenado em centavos)
</ResponseField>

<ResponseField name="Saldo em INR" type="integer">
...
<Card title="Obter Saldos das Carteiras dos Clientes" icon="wallet" href="/api-reference/customers/get-customer-wallets">
...
<Card title="Criar Lançamento no Livro da Carteira do Cliente" icon="plus" href="/api-reference/customers/post-customer-wallets-ledger-entries">
...
<Card title="Listar Lançamentos no Livro da Carteira do Cliente" icon="list" href="/api-reference/customers/get-customer-wallets-ledger-entries">
...
<Steps>
<Step title="Dar Boas-Vindas a Novos Clientes">
...
<Step title="Gerenciar Compras de Créditos">
...
<AccordionGroup>
<Accordion title="Clientes dos EUA">
...
<Accordion title="Clientes Indianos">
