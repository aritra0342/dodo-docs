...
<Info>
Créditos de downgrades usando `difference_immediately` são escopados por assinatura e aplicados automaticamente a renovações futuras. Eles são distintos de <a href="/features/customer-credit">Créditos de Clientes</a>.
</Info>
...
## Assinaturas com Mandatos em Conformidade com o RBI
  ...
  - **Cobranças abaixo de R$ 15.000:** Criamos um mandato sob demanda para R$ 15.000. O valor da assinatura é cobrado periodicamente de acordo com a frequência da sua assinatura, até o limite do mandato.
  - **Cobranças de R$ 15.000 ou mais:** Criamos um mandato de assinatura (ou mandato sob demanda) para o valor exato da assinatura.
  ...
  **Importante:** Ao atualizar ou rebaixar assinaturas, considere cuidadosamente os limites de mandato:
  ...
  - Se uma atualização/redução resultar em um valor de cobrança que exceda R$ 15.000 e ultrapasse o limite de pagamento sob demanda existente, a cobrança da transação pode falhar.
  ...
  Para cobranças de assinatura de R$ 15.000 ou mais:
