...
| Recurso | Checkout Overlay | Checkout Inline |
|---------|-----------------|-----------------|
...
<Tip>
Use **checkout overlay** para uma integração mais rápida com mudanças mínimas nas suas páginas existentes. Use **checkout inline** quando você quiser controle máximo sobre a experiência de checkout e branding sem costura.
</Tip>
...
<Card title="Guia de Integração" icon="book" href="/developer-resources/integration-guide">
    Guia completo para integrar os Pagamentos Dodo.
</Card>
</CardGroup>
