...
<CardGroup cols={2}>
<Card title="Início Rápido" icon="rocket" href="#integration-workflow">
  Coloque sua integração de pagamento móvel em funcionamento em 4 etapas simples
</Card>

<Card title="Exemplos de Plataforma" icon="code" href="#platform-specific-integration">
...
<Steps>
<Step title="Backend: Criar Sessão de Checkout">
<Card title="Documentação da API de Sessão de Checkout" icon="book" href="/developer-resources/checkout-session">
Aprenda como criar uma sessão de checkout em seu backend usando Node.js, Python e mais. Veja exemplos completos e referências de parâmetros na documentação dedicada da <strong>API de Sessões de Checkout</strong>.
</Card>
<Note>
...
<Step title="Móvel: Obter URL de Checkout">
...
<Step title="Móvel: Abrir Checkout no Navegador">
Abra a URL de checkout em um navegador seguro dentro do aplicativo para processamento de pagamento.

<Card 
  title="Veja exemplos de integração específicos da plataforma" 
  icon="box" 
  href="#platform-specific-integration"
>
  Veja o código completo e as instruções de configuração para pagamentos móveis Android, iOS e Flutter.
</Card>

</Step>

<Step title="Backend: Lidar com a Conclusão do Pagamento">
...
Adicione esta dependência ao seu `package.json`:
...
<Tip>
Use InAppBrowser para uma experiência de navegador nativa. Lide com deep links para callbacks de pagamento.
</Tip>
...
<Warning>
**Conformidade Regional**: SDKs de pagamento em aplicativos têm restrições regionais. No **iOS**, SDKs de pagamento nativos são legais apenas na **UE** (sob os termos do DMA). No **Android**, são legais em mercados de User Choice Billing (UCB). Para outras regiões, use a abordagem de links de checkout acima para garantir conformidade com a App Store e a Play Store.
</Warning>

<Card 
  title="Guia de Integração do SDK React Native" 
  icon="mobile-screen" 
  href="/developer-resources/react-native-integration"
>
  Guia completo para integrar o SDK React Native do Dodo com folhas de pagamento nativas, opções de personalização total e gerenciamento direto de pagamentos. Inclui instruções de configuração, implementação e testes.
</Card>

<Info>
Revise o [Guia de Bypass de Taxas da App Store](/features/bypassing-app-store-fees) para entender os requisitos de conformidade regional para integrações de pagamento em aplicativos.
</Info>
...
<Tip>
Use WebView para links de pagamento. Lide com a URL de redirecionamento para detectar a conclusão do pagamento.
</Tip>
...
<Check>
Para perguntas ou suporte, entre em contato com <a href="mailto:support@dodopayments.com">support@dodopayments.com</a>.
</Check>