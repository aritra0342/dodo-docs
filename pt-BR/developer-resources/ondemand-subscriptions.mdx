...
Para uma configuração geral de assinatura, consulte o [Guia de Integração de Assinaturas](/developer-resources/subscription-integration-guide).
...
<Accordion title="Parâmetros do Corpo da Solicitação">
  ...
  <ParamField body="on_demand.product_price" type="integer">
    Valor da cobrança inicial (na menor unidade monetária). Se especificado, esse valor substitui o preço original do produto definido durante a criação do produto. Se omitido, o preço armazenado do produto é usado. Exemplo: para cobrar $1,00, passe <code>100</code>.
  </ParamField>
