...
Campos principais da solicitação (corpo):
...
<Accordion title="Parâmetros do Corpo da Solicitação">
  ...
  <ParamField body="on_demand.adaptive_currency_fees_inclusive" type="boolean">
    Se verdadeiro, inclui taxas de moeda adaptativa dentro de <code>product_price</code>. Se falso, as taxas são adicionadas por cima. Ignorado quando a precificação adaptativa está desativada.
  </ParamField>
</Accordion>
</AccordionGroup>
...
Após a autorização do mandato, crie cobranças conforme necessário.
