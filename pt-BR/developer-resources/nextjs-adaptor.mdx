...
<Card title="Manipulador de Checkout" icon="cart-shopping" href="#checkout-route-handler">
    Integre o checkout dos pagamentos Dodo com fluxos estáticos, dinâmicos e de sessão.
</Card>
...
<Info>
Todos os exemplos assumem que você está usando o Next.js App Router.
</Info>

<Tabs>
<Tab title="Manipulador de Checkout">
  <Info>
  Use este manipulador para integrar o checkout dos pagamentos Dodo em seu aplicativo Next.js. Suporta fluxos de pagamento estáticos (GET), dinâmicos (POST) e de sessão de checkout (POST).
  </Info>
  <CodeGroup>
...
<Tab title="Manipulador de Webhook">
  <Info>
  Use este manipulador para receber e processar eventos de webhook dos pagamentos Dodo de forma segura em seu aplicativo Next.js.
  </Info>
  <CodeGroup>
