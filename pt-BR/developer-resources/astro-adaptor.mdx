...
<Card title="Manipulador de Checkout" icon="cart-shopping" href="#checkout-route-handler">
    Integre o checkout dos pagamentos Dodo em seu aplicativo Astro.
</Card>
...
<Tab title="Manipulador de Checkout">
  <Info>
  Use este manipulador para integrar o checkout dos pagamentos Dodo em seu aplicativo Astro. Suporta fluxos de pagamento estáticos (GET), dinâmicos (POST) e de sessão (POST).
  </Info>
  <CodeGroup>
...
<Tab title="Manipulador de Webhook">
  <Info>
  Use este manipulador para receber e processar eventos de webhook dos pagamentos Dodo de forma segura em seu aplicativo Astro.
  </Info>
  <CodeGroup>
