...
<Card title="Manipulador de Checkout" icon="cart-shopping" href="#checkout-route-handler">
    Integre o checkout dos Pagamentos Dodo em seu aplicativo Fastify.
</Card>
...
<Info>
Todos os exemplos assumem que você está usando o Fastify App Router.
</Info>

<Tabs>
<Tab title="Manipulador de Checkout">
  <Info>
  Use este manipulador para integrar o checkout dos Pagamentos Dodo em seu aplicativo Fastify. Suporta fluxos de pagamento estáticos (GET), dinâmicos (POST) e de sessão (POST).
  </Info>
  <CodeGroup>
...
<Tab title="Manipulador de Webhook">
  <Info>
  Use este manipulador para receber e processar eventos de webhook dos Pagamentos Dodo de forma segura em seu aplicativo Fastify.
  </Info>
  <CodeGroup>
...
As sessões de checkout fornecem experiências de checkout mais seguras e hospedadas que gerenciam o fluxo completo de pagamento para compras únicas e assinaturas com controle total de personalização.
