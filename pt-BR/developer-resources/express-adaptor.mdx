...
<Tab title="Manipulador de Webhook">
  <Info>
  Use este manipulador para receber e processar eventos de webhook dos pagamentos Dodo de forma segura em seu aplicativo Express.
  </Info>
  <CodeGroup> 
...
Especifique o valor do pagamento (por exemplo, <code>1000</code> para R$10,00).
</ParamField>
