...
<Tab title="Configuração do Portal do Cliente">
  <Info>
  Use esta função para permitir que os clientes gerenciem suas assinaturas e detalhes através do portal do cliente dos pagamentos Dodo. O cliente é automaticamente identificado através da função `identify`.
  </Info>
  <CodeGroup>
