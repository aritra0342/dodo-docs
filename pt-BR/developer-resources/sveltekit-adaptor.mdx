...
description: Aprenda como integrar Dodo Payments com seu projeto SveleteKit App
  Router usando nosso Adaptor SveleteKit. Cobre checkout, portal do cliente,
...
<Card title="Manipulador de Checkout" icon="cart-shopping" href="#checkout-route-handler">
    Integre o checkout do Dodo Payments em seu aplicativo SveleteKit.
</Card>
...
<Info>
Todos os exemplos assumem que você está usando o SveleteKit App Router.
</Info>

<Tabs>
<Tab title="Manipulador de Checkout">
  <Info>
  Use este manipulador para integrar o checkout do Dodo Payments em seu aplicativo SveleteKit. Suporta fluxos de pagamento estáticos (GET), dinâmicos (POST) e de sessão (POST).
  </Info>
  <CodeGroup>
...
<Tab title="Manipulador de Webhook">
  <Info>
  Use este manipulador para receber e processar eventos de webhook do Dodo Payments de forma segura em seu aplicativo SveleteKit.
  </Info>
  <CodeGroup>
...
O Manipulador de Rota do Portal do Cliente permite que você integre perfeitamente o portal do cliente do Dodo Payments em sua aplicação SveleteKit.
