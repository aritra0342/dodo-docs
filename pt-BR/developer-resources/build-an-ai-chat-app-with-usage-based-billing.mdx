...
**Agregue Sobre**: Digite → `totalTokens`

**Unidade de Medida**: Digite → `tokens`
...
<Steps>
<Step title="Obtenha a Chave de API do Dodo Payments">
1. No seu painel Dodo Payments, vá para **Desenvolvedores** → **Chaves de API**
...
**Preço Por Unidade**: Digite → `0.00001` (isso é $0,01 por 1.000 tokens ou $0,00001 por token)

**Limite Gratuito**: Digite → `10000` (os clientes recebem 10.000 tokens gratuitos por mês)
...
<Step title="Configure o TypeScript">
Crie `tsconfig.json`:
...
<Step title="Crie o servidor backend">
