...
<Info>
O SDK requer .NET 8.0 ou superior. Ele funciona com ASP.NET Core, aplicações Console e outros tipos de projetos .NET.
</Info>
...
Para desenvolvimento, use segredos de usuário para armazenar chaves de API:
