...
<Step title="Abra a Seção de Webhook">
  ...
  <Frame>
    <img src="/images/integrations/teams.png" alt="Adicionar Endpoint e dropdown de integrações" />
  </Frame>
</Step>

<Step title="Selecione Microsoft Teams">
  Escolha o cartão de integração <b>Microsoft Teams</b>.
</Step>

<Step title="Crie o Webhook do Teams">
...
<AccordionGroup>
<Accordion title="Sem mensagens no Teams">
...
<Accordion title="Problemas de formatação do cartão">
