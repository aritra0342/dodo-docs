...
Crie seu próprio projeto de plugin Figma usando o [guia de início rápido do plugin Figma](https://www.figma.com/plugin-docs/plugin-quickstart-guide/). Isso gerará um esqueleto com um `manifest.json` arquivo.
