...
<Step title="Abra a Seção de Webhook">
  No seu painel de pagamentos Dodo, navegue até <b>Webhooks → + Adicionar Endpoint</b> e expanda o menu suspenso de integrações.
  <Frame>
    <img src="/images/integrations/zapier.png" alt="Adicionar Endpoint e menu suspenso de integrações" />
  </Frame>
</Step>

<Step title="Selecione Zapier">
  Escolha o cartão de integração <b>Zapier</b>.
</Step>

<Step title="Crie um Zap no Zapier">
...
<AccordionGroup>
<Accordion title="Zap não acionando">
