...
<CardGroup cols={3}>
  <Card title="Produk & Harga" icon="box">
    Migrasikan semua produk dan detail harga Anda.
  </Card>
  <Card title="Data Pelanggan" icon="users">
    Transfer seluruh database pelanggan Anda, termasuk detail kontak.
  </Card>
  <Card title="Kode Diskon & Promosi" icon="tag">
    Pindahkan semua kode diskon dan penawaran promosi dengan mulus.
  </Card>
</CardGroup>
...
<Note>
Anda perlu menginstal Node.js ≥ 18 di komputer Anda.
</Note>
