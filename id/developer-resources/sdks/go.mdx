...
<Info>
SDK mendukung Go 1.18 dan versi yang lebih baru, memanfaatkan fitur Go modern untuk kinerja optimal.
</Info>
...
<Card title="Tipe Kuat" icon="shield-check">
  Permintaan dan respons yang terketik dengan kuat untuk keamanan waktu kompilasi
</Card>
