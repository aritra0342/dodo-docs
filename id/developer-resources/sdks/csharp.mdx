...
<Info>
SDK memerlukan .NET 8.0 atau lebih tinggi. Ini bekerja dengan ASP.NET Core, aplikasi Console, dan jenis proyek .NET lainnya.
</Info>
...
Konfigurasi secara manual dengan token bearer:
...
Buat controller menggunakan injeksi ketergantungan:
...
- **GitHub**: Buka masalah di [repository](https://github.com/dodopayments/dodopayments-csharp)
