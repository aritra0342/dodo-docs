...
**Gejala**: Biaya perubahan rencana gagal dan langganan berpindah ke status `on_hold`

**Apa yang terjadi**:
Ketika biaya perubahan rencana gagal, langganan secara otomatis ditempatkan dalam status `on_hold`. Langganan tidak akan diperbarui secara otomatis hingga metode pembayaran diperbarui.

**Solusi**: Perbarui metode pembayaran untuk mengaktifkan kembali langganan

Untuk mengaktifkan kembali langganan dari status `on_hold` setelah perubahan rencana yang gagal:
...
<Step title="Uji berbagai mode proration">
