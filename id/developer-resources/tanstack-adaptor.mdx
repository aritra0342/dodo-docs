...
<Tab title="Pengelola Checkout">
  <Info>
  Gunakan pengelola ini untuk mengintegrasikan checkout Dodo Payments ke dalam aplikasi Tanstack Anda. Mendukung alur pembayaran statis (GET), dinamis (POST), dan sesi (POST).
  </Info>
  <CodeGroup>
...
<Tab title="Pengelola Webhook">
  <Info>
  Gunakan pengelola ini untuk menerima dan memproses acara webhook Dodo Payments dengan aman di aplikasi Tanstack Anda.
  </Info>
  <CodeGroup>
