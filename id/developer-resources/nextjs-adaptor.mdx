...
<Tab title="Pengelola Checkout">
  <Info>
  Gunakan pengelola ini untuk mengintegrasikan checkout Dodo Payments ke dalam aplikasi Next.js Anda. Mendukung alur pembayaran statis (GET), dinamis (POST), dan sesi checkout (POST).
  </Info>
  <CodeGroup>
...
<Tab title="Pengelola Webhook">
  <Info>
  Gunakan pengelola ini untuk menerima dan memproses acara webhook Dodo Payments dengan aman di aplikasi Next.js Anda.
  </Info>
  <CodeGroup>
