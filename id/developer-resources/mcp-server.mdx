...
<Tab title="Claude Desktop">
Atur server Dodo Payments MCP di Claude Desktop untuk memungkinkan akses percakapan ke data pembayaran Anda.
<Steps>
...
Atur server Dodo Payments MCP di Cline (VS Code) untuk memungkinkan akses percakapan ke data pembayaran Anda.
<Steps>
...
| Header | Deskripsi |
|--------|-------------|
| `Authorization` | Otentikasi token Bearer |
...
Saat menerapkan secara jarak jauh, selalu minta otentikasi melalui header `Authorization` atau header `x-dodo-payments-api-key`.
