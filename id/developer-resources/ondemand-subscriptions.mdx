...
<Accordion title="Parameter Badan Permintaan">
  ...
  <ParamField body="on_demand.product_price" type="integer">
    Jumlah biaya awal (dalam unit mata uang terkecil). Jika ditentukan, nilai ini akan menggantikan harga asli produk yang ditetapkan selama pembuatan produk. Jika diabaikan, harga yang disimpan produk akan digunakan. Contoh: untuk mengenakan biaya $1,00, kirim <code>100</code>.
  </ParamField>
  ...
  <ParamField body="on_demand.adaptive_currency_fees_inclusive" type="boolean">
    Jika benar, menyertakan biaya mata uang adaptif dalam <code>product_price</code>. Jika salah, biaya ditambahkan di atasnya. Diabaikan saat penetapan harga adaptif dinonaktifkan.
  </ParamField>
</Accordion>
</AccordionGroup>
...
<AccordionGroup>
  <Accordion title="Parameter badan permintaan biaya">
    ...
    <ParamField body="adaptive_currency_fees_inclusive" type="boolean">
      Jika benar, menyertakan biaya mata uang adaptif dalam <code>product_price</code>. Jika salah, biaya ditambahkan di atasnya.
    </ParamField>
