...
1. Pergi ke [Dasbor DodoPayments](https://app.dodopayments.com) → Pengembang → Webhooks
...
**Lihat log di Dasbor Netlify:**
1. Pilih situs Anda → tab **Fungsi**
...
| Variabel lingkungan tidak tersedia | Atur variabel di CLI atau dasbor, lalu terapkan kembali |
