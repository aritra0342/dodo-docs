...
1. Pergi ke [DodoPayments Dashboard](https://app.dodopayments.com) → Pengembang → Webhook
...
| Kesalahan izin database | Pastikan menggunakan Kunci Peran Layanan |
| Kesalahan verifikasi JWT | Terapkan dengan flag `--no-verify-jwt` |
| Fungsi tidak ditemukan | Verifikasi referensi proyek benar dan fungsi telah diterapkan |
