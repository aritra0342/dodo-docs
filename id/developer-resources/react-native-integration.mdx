...
<Step title="Buat fungsi utilitas pembayaran">
    ...
    <Note>
    Fungsi ini mengasumsikan Anda memiliki endpoint API backend yang membuat niat pembayaran dan mengembalikan rahasia klien. Pastikan backend Anda dikonfigurasi dengan benar untuk menangani pembuatan pembayaran. Lihat [Tutorial Integrasi API kami](/developer-resources/integration-tutorial) untuk contoh pengaturan backend.
    </Note>
</Step>
