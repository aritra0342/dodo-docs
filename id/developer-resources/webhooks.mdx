...
<Steps>
<Step title="Lihat Peristiwa yang Tersedia">
...
<Accordion title="Tangani peristiwa duplikat" icon="rotate">
...
<Expandable title="Properti objek Data">
  ...
  Bidang tambahan bervariasi berdasarkan tipe peristiwa. Lihat dokumentasi spesifik peristiwa untuk skema lengkap.
</Expandable>
</ResponseField>
...
<Steps>
<Step title="Navigasikan ke Webhooks">
    Pergi ke Dasbor Dodo Payments Anda dan navigasikan ke `Settings > Webhooks`.
</Step>
...
<Steps>
<Step title="Pilih Tipe Peristiwa">
