...
<CardGroup cols={2}>
<Card title="Mulai Cepat" icon="rocket" href="#integration-workflow">
  Dapatkan integrasi pembayaran mobile Anda berjalan dalam 4 langkah sederhana
</Card>

<Card title="Contoh Platform" icon="code" href="#platform-specific-integration">
...
<Steps>
<Step title="Backend: Buat Sesi Checkout">
<Card title="Dokumentasi API Sesi Checkout" icon="book" href="/developer-resources/checkout-session">
Pelajari cara membuat sesi checkout di backend Anda menggunakan Node.js, Python, dan lainnya. Lihat contoh lengkap dan referensi parameter di dokumentasi <strong>API Sesi Checkout</strong> yang didedikasikan.
</Card>
<Note>
...
<Step title="Mobile: Dapatkan URL Checkout">
...
<Step title="Mobile: Buka Checkout di Browser">
Buka URL checkout di browser dalam aplikasi yang aman untuk pemrosesan pembayaran.

<Card 
  title="Lihat contoh integrasi spesifik platform" 
  icon="box" 
...
<Step title="Backend: Tangani Penyelesaian Pembayaran">
...
<Card 
  title="Panduan Integrasi SDK React Native" 
  icon="mobile-screen" 
...
<Info>
Tinjau [Panduan Penghindaran Biaya App Store](/features/bypassing-app-store-fees) untuk memahami persyaratan kepatuhan regional untuk integrasi pembayaran dalam aplikasi.
</Info>
