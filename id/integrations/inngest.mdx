...
<Step title="Buka Bagian Webhook">
  ...
  <Frame>
    <img src="/images/integrations/inngest.png" alt="Tambah Endpoint dan dropdown integrasi" />
  </Frame>
</Step>

<Step title="Pilih Inngest">
  Pilih kartu integrasi <b>Inngest</b>.
</Step>

<Step title="Buat Fungsi Inngest">
...
<AccordionGroup>
<Accordion title="Pemrosesan Pembayaran">
...
<Accordion title="Manajemen Langganan">
...
<Accordion title="Analitik & Pelaporan">
...
<AccordionGroup>
<Accordion title="Fungsi tidak memicu">
...
<Accordion title="Data tidak diterima dengan benar">
