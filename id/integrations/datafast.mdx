...
<Step title="Instal Skrip DataFast">
  Pertama, instal skrip pelacakan DataFast di situs web Anda. Ini membuat cookie `datafast_visitor_id` yang melacak pengunjung Anda.
...
- Tinjau [dokumentasi API Pembayaran DataFast](https://datafa.st/docs/payments-api) untuk panduan tambahan
</Accordion>
