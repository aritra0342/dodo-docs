...
Klon repositori [dodopayments-figma](https://github.com/dodopayments/dodopayments-figma) dan perbarui `manifest.json` dengan nama dan ID dari folder plugin yang Anda hasilkan.
