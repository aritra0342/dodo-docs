...
<Step title="Buka Bagian Webhook">
  Di dasbor Pembayaran Dodo Anda, navigasikan ke <b>Webhook → + Tambah Endpoint</b> dan perluas dropdown integrasi.
  <Frame>
    <img src="/images/integrations/resend.png" alt="Tambah Endpoint dan dropdown integrasi" />
  </Frame>
</Step>

<Step title="Pilih Kirim Ulang">
  Pilih kartu integrasi <b>Kirim Ulang</b>.
</Step>
