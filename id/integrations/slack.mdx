...
- Gunakan lampiran pesan yang kaya dengan warna, bidang, dan format untuk kejelasan dan tindakan.
- Selalu sertakan data kunci seperti jumlah, email pelanggan, dan ID untuk identifikasi cepat.
- Pilih warna yang sesuai dengan jenis peristiwa: hijau (`good`) untuk keberhasilan, merah (`danger`) untuk sengketa atau kegagalan, kuning (`warning`) untuk pembatalan, dan biru (`#36a64f`) untuk peristiwa informasi.
- Tambahkan cap waktu untuk membantu melacak kapan setiap peristiwa terjadi.
