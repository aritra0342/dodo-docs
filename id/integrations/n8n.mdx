...
<Step title="Buka Bagian Webhook">
  ...
  <Frame>
    <img src="/images/integrations/n8n.png" alt="Tambah Endpoint dan dropdown integrasi" />
  </Frame>
</Step>

<Step title="Pilih N8N">
  Pilih kartu integrasi <b>N8N</b>.
</Step>

<Step title="Buat Webhook di N8N">
  Di N8N, buat alur kerja baru dan tambahkan node <b>Webhook</b> sebagai pemicu. Konfigurasikan sebagai webhook POST dan salin URL webhook.
</Step>
...
<Step title="Aktifkan Alur Kerja">
...
<AccordionGroup>
<Accordion title="Notifikasi Email">
...
<Accordion title="Pemrosesan Data">
...
<AccordionGroup>
<Accordion title="Alur kerja tidak terpicu">
...
<Accordion title="Kesalahan eksekusi alur kerja">
