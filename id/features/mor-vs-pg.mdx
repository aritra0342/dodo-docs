...
<Note>
Bayangkan menjual langganan digital kepada pengguna di Prancis. Dengan Dodo Payments, kami mengumpulkan pembayaran, mengajukan VAT kepada otoritas Prancis, dan mengirimkan Anda pendapatan bersih. Tanpa sakit kepala pajak. Tanpa pengacara. Hanya pertumbuhan.
</Note>
...
<Tip>
"Anggaplah payment gateway sebagai terowongan. Sekarang bayangkan Merchant of Record sebagai terowongan, kereta, pengemudi, dan staf tiket semuanya dalam satu."
</Tip>
...
<Note>
Untuk banyak startup, menggunakan gateway mungkin cukup pada awalnya - tetapi seiring kompleksitas tumbuh, beralih ke MoR dapat menghemat waktu, mengurangi risiko, dan mempercepat pertumbuhan internasional.
</Note>
...
<CardGroup cols={2}>
<Card title="Dukungan Mata Uang Adaptif" icon="money-bill-wave" href="/features/adaptive-currency">
Pelajari bagaimana Dodo secara otomatis menyajikan harga dalam mata uang lokal pelanggan Anda
</Card>

<Card title="Metode Pembayaran yang Didukung" icon="credit-card" href="/features/payment-methods">
Temukan 30+ metode pembayaran yang tersedia melalui Dodo Payments
</Card>
</CardGroup>
...
<CardGroup cols={2}>
<Card title="Daftar Gratis" icon="user-plus" href="https://app.dodopayments.com/signup">
Buat akun Dodo Payments Anda dan mulai menjual secara global hari ini
</Card>

<Card title="Bicara dengan Tim Penjualan" icon="envelope" href="mailto:founders@dodopayments.com">
Dapatkan panduan pribadi dari tim kami
</Card>
</CardGroup>

<Tip>
Biarkan Dodo menangani hal-hal sulit - sehingga Anda dapat fokus pada membangun produk yang hebat.
</Tip>