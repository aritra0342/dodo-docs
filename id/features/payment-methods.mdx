...
**Biaya langganan gagal setelah upgrade/downgrade:**
...
**Solusi:** Minta pelanggan untuk memperbarui metode pembayaran mereka atau sesuaikan jumlah langganan agar tetap dalam batas mandat.
...
**Solusi:** Pantau peristiwa webhook untuk pembatalan mandat dan kegagalan pembayaran. Terapkan logika pengulangan atau minta pelanggan untuk menetapkan kembali metode pembayaran mereka.
...
Memperbarui metode pembayaran untuk langganan aktif hanya memperbarui metode pembayaran untuk pembaruan mendatang. Tidak ada biaya langsung yang dibuat.

**Untuk langganan yang ditahan:**
Ketika langganan berada dalam status `on_hold` (karena pembaruan gagal atau biaya perubahan rencana yang gagal), memperbarui metode pembayaran akan:
