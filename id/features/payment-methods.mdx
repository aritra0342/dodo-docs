...
- Mungkin ada konfigurasi yang bertentangan di dasbor merchant Anda
...
Ketika langganan berada dalam keadaan `on_hold` (karena pembaruan gagal atau biaya perubahan rencana yang gagal), memperbarui metode pembayaran akan:
