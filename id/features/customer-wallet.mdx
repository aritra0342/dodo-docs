...
<CardGroup cols={3}>
<Card title="Dapatkan Dompet Pelanggan" icon="code" href="/api-reference/customers/get-customer-wallets">
  Periksa saldo dompet pelanggan di berbagai mata uang.
</Card>

<Card title="Buat Entri Buku Besar" icon="plus" href="/api-reference/customers/post-customer-wallets-ledger-entries">
  Tambahkan atau hapus kredit dari dompet pelanggan.
</Card>

<Card title="Daftar Entri Buku Besar" icon="list" href="/api-reference/customers/get-customer-wallets-ledger-entries">
...
<Frame>
  <img src="/images/customer/customer-wallet.png" alt="Dompet Pelanggan" />
</Frame>
...
<Info>
Saat ini, hanya saldo <strong>USD</strong> dan <strong>INR</strong> yang tersedia. Lebih banyak mata uang akan segera hadir.
</Info>
...
<Card title="Dapatkan Saldo Dompet Pelanggan" icon="wallet" href="/api-reference/customers/get-customer-wallets">
...
<Card title="Buat Entri Buku Besar Dompet Pelanggan" icon="plus" href="/api-reference/customers/post-customer-wallets-ledger-entries">
  Tambahkan atau hapus kredit dari dompet pelanggan.
</Card>
...
<Card title="Daftar Entri Buku Besar Dompet Pelanggan" icon="list" href="/api-reference/customers/get-customer-wallets-ledger-entries">
...
<Steps>
<Step title="Sambut Pelanggan Baru">
...
<Step title="Tangani Pembelian Kredit">
...
<Step title="Kenakan Biaya untuk Penggunaan">
...
<Accordion title="Pelanggan India">
