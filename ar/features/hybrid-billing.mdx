...
**الحلول**:
1. تحقق من أن إدخال الأحداث يعمل (تحقق من استجابات API)
2. تأكد من أن `customer_id` يتطابق مع عميل الاشتراك
3. تحقق من أن `event_name` يتطابق مع تكوين المقياس
...
**الحلول**:
1. استخدم `previewChangePlan` API لإظهار الرسوم الدقيقة قبل التأكيد
2. تواصل بأن التقسيم ينطبق على الاشتراك والإضافات
3. اعتبر استخدام `difference_immediately` لفوترة ترقية أبسط
</Accordion>
