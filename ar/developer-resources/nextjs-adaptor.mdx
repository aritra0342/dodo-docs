...
<Card title="معالج الدفع" icon="cart-shopping" href="#checkout-route-handler">
    دمج دفع دودي مع التدفقات الثابتة، الديناميكية، والجلسات.
</Card>
...
<Card title="الويب هوكس" icon="bell" href="#webhook-route-handler">
    استلام ومعالجة أحداث الويب هوك لمدفوعات دودي.
</Card>
</CardGroup>
...
<Warning>
لا تقم بالتزام ملف <code>.env</code> أو الأسرار في نظام التحكم بالإصدارات.
</Warning>
</Step>
</Steps>
...
<Tab title="معالج الدفع">
  <Info>
  استخدم هذا المعالج لدمج دفع دودي في تطبيق Next.js الخاص بك. يدعم التدفقات الثابتة (GET)، الديناميكية (POST)، وجلسات الدفع (POST).
  </Info>
  <CodeGroup>
...
<Tab title="معالج بوابة العملاء">
  <Info>
  استخدم هذا المعالج للسماح للعملاء بإدارة اشتراكاتهم وتفاصيلهم عبر بوابة عملاء مدفوعات دودي.
  </Info>
  <CodeGroup>
...
<Tab title="معالج الويب هوك">
  <Info>
  استخدم هذا المعالج لاستلام ومعالجة أحداث الويب هوك لمدفوعات دودي بشكل آمن في تطبيق Next.js الخاص بك.
  </Info>
  <CodeGroup>
...
<Info>
تدعم مدفوعات دودي ثلاثة أنواع من تدفقات الدفع لدمج المدفوعات في موقعك، هذا الموصل يدعم جميع أنواع تدفقات الدفع.
</Info>
