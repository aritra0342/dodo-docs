...
<Card title="معالج الدفع" icon="cart-shopping" href="#checkout-route-handler">
    دمج دفع دودي في تطبيق هونو الخاص بك.
</Card>
...
<Card title="الويب هوكس" icon="bell" href="#webhook-route-handler">
    استلام ومعالجة أحداث الويب هوكس لمدفوعات دودي.
</Card>
</CardGroup>
...
<Info>
تفترض جميع الأمثلة أنك تستخدم موجه تطبيق هونو.
</Info>

<Tabs>
<Tab title="معالج الدفع">
  <Info>
  استخدم هذا المعالج لدمج دفع دودي في تطبيق هونو الخاص بك. يدعم التدفقات الثابتة (GET)، الديناميكية (POST)، والجلسات (POST).
  </Info>
  <CodeGroup>
...
<Tab title="معالج الويب هوك">
  <Info>
  استخدم هذا المعالج لاستلام ومعالجة أحداث الويب هوكس لمدفوعات دودي بشكل آمن في تطبيق هونو الخاص بك.
  </Info>
  <CodeGroup>
...
<Warning>
إذا كانت <code>productId</code> مفقودة، فإن المعالج يرجع استجابة 400. كما أن المعلمات غير الصحيحة تؤدي أيضاً إلى استجابة 400.
</Warning>
