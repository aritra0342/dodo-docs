...
<Card title="معالج الدفع" icon="cart-shopping" href="#checkout-route-handler">
    دمج دفع دودو في تطبيق تانستاك الخاص بك.
</Card>
...
<Info>
تفترض جميع الأمثلة أنك تستخدم موجه تطبيق تانستاك.
</Info>

<Tabs>
<Tab title="معالج الدفع">
  <Info>
  استخدم هذا المعالج لدمج دفع دودو في تطبيق تانستاك الخاص بك. يدعم تدفقات الدفع الثابتة (GET)، الديناميكية (POST)، والجلسات (POST).
  </Info>
  <CodeGroup>
...
<Tab title="معالج ويب هوك">
  <Info>
  استخدم هذا المعالج لاستلام ومعالجة أحداث ويب هوك مدفوعات دودو بشكل آمن في تطبيق تانستاك الخاص بك.
  </Info>
  <CodeGroup>
