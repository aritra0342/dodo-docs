...
**اسم العداد**: انسخ والصق هذا بالضبط → `Image Generation Meter`
...
بالإضافة إلى ذلك، قم بتعيين **السعر الثابت** إلى `0` لضمان فرض رسوم على العملاء فقط بناءً على استخدامهم، دون أي رسوم أساسية.
