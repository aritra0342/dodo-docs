...
<Card title="معالج الدفع" icon="cart-shopping" href="#checkout-route-handler">
    دمج دفع دودو في تطبيق أسترو الخاص بك.
</Card>
...
<Info>
تفترض جميع الأمثلة أنك تستخدم موجه تطبيق أسترو.
</Info>

<Tabs>
<Tab title="معالج الدفع">
  <Info>
  استخدم هذا المعالج لدمج دفع دودو في تطبيق أسترو الخاص بك. يدعم تدفقات الدفع الثابتة (GET)، الديناميكية (POST)، والجلسات (POST).
  </Info>
  <CodeGroup>
...
<Tab title="معالج الويب هوك">
  <Info>
  استخدم هذا المعالج لاستلام ومعالجة أحداث الويب هوك لمدفوعات دودو بشكل آمن في تطبيق أسترو الخاص بك.
  </Info>
  <CodeGroup>
...
<Warning>
إذا كان <code>productId</code> مفقودًا، فإن المعالج يرجع استجابة 400. كما أن المعلمات الاستعلام غير الصالحة تؤدي أيضًا إلى استجابة 400.
</Warning>
