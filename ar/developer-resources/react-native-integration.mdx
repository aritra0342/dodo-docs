...
<Step title="إنشاء دالة مساعدة للدفع">
    ...
    <Note>
    تفترض هذه الدالة أن لديك نقطة نهاية واجهة برمجة التطبيقات الخلفية التي تنشئ نوايا الدفع وتعيد سر العميل. تأكد من أن واجهتك الخلفية مُعدة بشكل صحيح للتعامل مع إنشاء الدفع. راجع [دليل تكامل API](/developer-resources/integration-tutorial) للحصول على أمثلة إعداد الخلفية.
    </Note>
</Step>
...
| `componentBackground` | لون خلفية المدخلات، والألسنة، والمكونات الأخرى |
| `componentBorder` | لون الحدود الخارجية للمدخلات، والألسنة، والمكونات الأخرى |
