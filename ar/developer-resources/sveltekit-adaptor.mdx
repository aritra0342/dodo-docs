---
title: موصل SveleteKit
description: تعلم كيفية دمج مدفوعات دودو مع مشروع SveleteKit App Router الخاص بك
  باستخدام موصل SveleteKit. يغطي عملية الدفع، بوابة العملاء، الويب هوكس، وإعداد
  البيئة الآمنة.
icon: code-merge
---
...
<Card title="معالج الدفع" icon="cart-shopping" href="#checkout-route-handler">
    دمج عملية دفع دودو في تطبيق SveleteKit الخاص بك.
</Card>
...
<Info>
تفترض جميع الأمثلة أنك تستخدم SveleteKit App Router.
</Info>

<Tabs>
<Tab title="معالج الدفع">
  <Info>
  استخدم هذا المعالج لدمج عملية دفع دودو في تطبيق SveleteKit الخاص بك. يدعم تدفقات الدفع الثابتة (GET)، الديناميكية (POST)، والجلسات (POST).
  </Info>
  <CodeGroup>
...
<Tab title="معالج الويب هوك">
  <Info>
  استخدم هذا المعالج لاستلام ومعالجة أحداث الويب هوك لمدفوعات دودو بشكل آمن في تطبيق SveleteKit الخاص بك.
  </Info>
  <CodeGroup>
...
يمكنك من خلال معالج مسار بوابة العملاء دمج بوابة عملاء مدفوعات دودو بسلاسة في تطبيق SveleteKit الخاص بك.
