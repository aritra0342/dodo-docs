...
| الأفضل لـ | التكامل السريع، الصفحات الحالية | صفحات دفع مخصصة، تدفقات عالية التحويل |
...
<Card title="الويب هوكس" icon="webhook" href="/developer-resources/webhooks">
    تعامل مع أحداث الدفع على الخادم باستخدام الويب هوكس.
</Card>

<Card title="دليل التكامل" icon="book" href="/developer-resources/integration-guide">
    دليل كامل لتكامل مدفوعات دودي.
</Card>
</CardGroup>
