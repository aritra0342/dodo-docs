...
<Step title="الحصول على مفتاح سري">
...
<Steps>
<Step title="انتقل إلى تفاصيل Webhook">
...
<Accordion title="استجب على الفور" icon="bolt">
...
<Accordion title="تعامل مع الأحداث المكررة" icon="rotate">
