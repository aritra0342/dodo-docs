...
<Tab title="معالج ويب هوك">
  <Info>
  استخدم هذا المعالج لاستلام ومعالجة أحداث ويب هوك مدفوعات دودي بشكل آمن في تطبيق Fastify الخاص بك.
  </Info>
  <CodeGroup>
...
<Warning>
إذا كانت <code>productId</code> مفقودة، فإن المعالج يرجع استجابة 400. كما أن المعلمات غير الصحيحة تؤدي أيضًا إلى استجابة 400.
</Warning>
...
توفر جلسات الدفع تجربة دفع أكثر أمانًا وقابلة للتخصيص تتعامل مع تدفق الدفع الكامل لكل من المشتريات لمرة واحدة والاشتراكات مع التحكم الكامل في التخصيص.
...
إذا تم تعيينها على <code>true</code>، يتم إرسال بريد إلكتروني للعميل مع رابط البوابة.
</ParamField>
