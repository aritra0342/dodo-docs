...
<Info>
يدعم SDK Go 1.18 والإصدارات الأحدث، مستفيدًا من ميزات Go الحديثة لتحقيق أداء مثالي.
</Info>
...
<Card title="النوع القوي" icon="shield-check">
  طلبات واستجابات ذات نوعية قوية لضمان الأمان في وقت الترجمة
</Card>
...
<Card title="آمن للاستخدام المتزامن" icon="bolt">
...
هل تحتاج إلى مساعدة بشأن SDK Go؟
