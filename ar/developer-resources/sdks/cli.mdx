...
- `checkout-sessions` - إدارة جلسات الدفع
...
<Info>
استخدم `dodopayments --help` لرؤية جميع الموارد المتاحة و `dodopayments [resource] --help` لأوامر محددة بالموارد.
</Info>
