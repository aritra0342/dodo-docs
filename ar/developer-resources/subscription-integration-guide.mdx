...
<Steps>
<Step title="التعامل مع ويب هوك subscription.on_hold">
...
لإنشاء اشتراك عند الطلب، استخدم واجهة برمجة التطبيقات [POST /subscriptions](/api-reference/subscriptions/post-subscriptions) وأدرج حقل `on_demand` في جسم الطلب الخاص بك. يتيح لك ذلك تفويض طريقة الدفع دون فرض رسوم فورية، أو تعيين سعر أولي مخصص.
