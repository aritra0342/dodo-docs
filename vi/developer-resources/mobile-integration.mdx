...
<CardGroup cols={2}>
<Card title="Bắt Đầu Nhanh" icon="rocket" href="#integration-workflow">
  Đưa tích hợp thanh toán di động của bạn vào hoạt động trong 4 bước đơn giản
</Card>

<Card title="Ví Dụ Nền Tảng" icon="code" href="#platform-specific-integration">
...
<Steps>
<Step title="Backend: Tạo Phiên Thanh Toán">
<Card title="Tài Liệu API Phiên Thanh Toán" icon="book" href="/developer-resources/checkout-session">
Tìm hiểu cách tạo một phiên thanh toán trong backend của bạn bằng Node.js, Python và nhiều hơn nữa. Xem các ví dụ hoàn chỉnh và tham chiếu tham số trong tài liệu <strong>API Phiên Thanh Toán</strong> chuyên dụng.
</Card>
<Note>
...
<Step title="Di Động: Lấy URL Thanh Toán">
...
<Step title="Di Động: Mở Thanh Toán Trong Trình Duyệt">
Mở URL thanh toán trong trình duyệt trong ứng dụng an toàn để xử lý thanh toán.

<Card 
  title="Xem ví dụ tích hợp cụ thể cho nền tảng" 
  icon="box" 
  href="#platform-specific-integration"
>
  Xem mã đầy đủ và hướng dẫn thiết lập cho thanh toán di động Android, iOS và Flutter.
</Card>

</Step>

<Step title="Backend: Xử Lý Hoàn Tất Thanh Toán">
...
Thêm phụ thuộc này vào `package.json`:
...
<Tip>
Sử dụng InAppBrowser để có trải nghiệm trình duyệt gốc. Xử lý các liên kết sâu cho các callback thanh toán.
</Tip>
...
<Warning>
**Tuân Thủ Khu Vực**: Các SDK thanh toán trong ứng dụng có các hạn chế khu vực. Trên **iOS**, các SDK thanh toán gốc chỉ hợp pháp trong **EU** (theo các điều khoản DMA). Trên **Android**, chúng hợp pháp trong các thị trường Lựa Chọn Người Dùng (UCB). Đối với các khu vực khác, hãy sử dụng phương pháp liên kết thanh toán ở trên để đảm bảo tuân thủ App Store và Play Store.
</Warning>

<Card 
  title="Hướng Dẫn Tích Hợp SDK React Native" 
  icon="mobile-screen" 
  href="/developer-resources/react-native-integration"
>
  Hướng dẫn hoàn chỉnh để tích hợp SDK React Native của Dodo với các bảng thanh toán gốc, tùy chọn tùy chỉnh đầy đủ và xử lý thanh toán trực tiếp. Bao gồm hướng dẫn thiết lập, triển khai và kiểm tra.
</Card>

<Info>
Xem [Hướng Dẫn Bỏ Qua Phí App Store](/features/bypassing-app-store-fees) để hiểu các yêu cầu tuân thủ khu vực cho các tích hợp thanh toán trong ứng dụng.
</Info>
...
<Check>
Để có câu hỏi hoặc hỗ trợ, hãy liên hệ với <a href="mailto:support@dodopayments.com">support@dodopayments.com</a>.
</Check>