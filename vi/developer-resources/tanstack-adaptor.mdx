...
<Card title="Xử lý Thanh toán" icon="cart-shopping" href="#checkout-route-handler">
    Tích hợp thanh toán Dodo vào ứng dụng Tanstack của bạn.
</Card>
...
<Tab title="Xử lý Webhook">
  <Info>
  Sử dụng trình xử lý này để nhận và xử lý các sự kiện webhook của Dodo Payments một cách an toàn trong ứng dụng Tanstack của bạn.
  </Info>
  <CodeGroup>
