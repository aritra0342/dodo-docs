...
Trình xử lý webhook:
1. **Vô hiệu hóa phân tích nội dung** - Để truy cập nội dung thô cho việc xác minh chữ ký
...
4. **Ghi lại sự kiện** - Lưu trữ webhook thô trong bảng `webhook_events` để theo dõi kiểm toán
