...
Cập nhật URL webhook trong [bảng điều khiển Dodo](https://app.dodopayments.com/developer/webhooks) đến URL ngrok. Hãy chắc chắn cập nhật tệp `.env` của bạn với khóa xác minh webhook chính xác.
</Accordion>
