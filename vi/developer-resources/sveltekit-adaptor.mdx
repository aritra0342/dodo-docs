...
description: Tìm hiểu cách tích hợp Dodo Payments với dự án SveleteKit App
  Router của bạn bằng cách sử dụng SveleteKit Adaptor của chúng tôi. Bao gồm
  thanh toán, cổng thông tin khách hàng, webhook và thiết lập môi trường an
  toàn.
icon: code-merge
---
...
<Card title="Xử lý Thanh Toán" icon="cart-shopping" href="#checkout-route-handler">
    Tích hợp thanh toán Dodo Payments vào ứng dụng SveleteKit của bạn.
</Card>
...
<Info>
Tất cả các ví dụ đều giả định rằng bạn đang sử dụng SveleteKit App Router.
</Info>

<Tabs>
<Tab title="Xử lý Thanh Toán">
  <Info>
  Sử dụng trình xử lý này để tích hợp thanh toán Dodo Payments vào ứng dụng SveleteKit của bạn. Hỗ trợ các luồng thanh toán tĩnh (GET), động (POST) và theo phiên (POST).
  </Info>
  <CodeGroup>
...
<Tab title="Xử lý Webhook">
  <Info>
  Sử dụng trình xử lý này để nhận và xử lý các sự kiện webhook của Dodo Payments một cách an toàn trong ứng dụng SveleteKit của bạn.
  </Info>
  <CodeGroup>
...
Xử lý đường dẫn cổng thông tin khách hàng cho phép bạn tích hợp liền mạch cổng thông tin khách hàng Dodo Payments vào ứng dụng SveleteKit của bạn.
