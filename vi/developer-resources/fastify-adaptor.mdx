...
<Card title="Xử lý Thanh toán" icon="cart-shopping" href="#checkout-route-handler">
    Tích hợp thanh toán Dodo vào ứng dụng Fastify của bạn.
</Card>
<Card title="Cổng Khách Hàng" icon="user" href="#customer-portal-route-handler">
...
<Info>
Tất cả các ví dụ đều giả định rằng bạn đang sử dụng Fastify App Router.
</Info>

<Tabs>
<Tab title="Xử lý Thanh toán">
  <Info>
  Sử dụng bộ xử lý này để tích hợp thanh toán Dodo vào ứng dụng Fastify của bạn. Hỗ trợ các luồng thanh toán tĩnh (GET), động (POST) và phiên (POST).
  </Info>
  <CodeGroup>
...
<Tab title="Xử lý Cổng Khách Hàng">
  <Info>
...
<Tab title="Xử lý Webhook">
  <Info>
  Sử dụng bộ xử lý này để nhận và xử lý các sự kiện webhook của Dodo Payments một cách an toàn trong ứng dụng Fastify của bạn.
  </Info>
  <CodeGroup>
