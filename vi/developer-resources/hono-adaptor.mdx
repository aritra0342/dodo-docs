...
<Card title="Xử lý Thanh Toán" icon="cart-shopping" href="#checkout-route-handler">
    Tích hợp thanh toán Dodo vào ứng dụng Hono của bạn.
</Card>
...
<Info>
Tất cả các ví dụ đều giả định rằng bạn đang sử dụng Hono App Router.
</Info>

<Tabs>
<Tab title="Xử lý Thanh Toán">
  <Info>
  Sử dụng trình xử lý này để tích hợp thanh toán Dodo vào ứng dụng Hono của bạn. Hỗ trợ các luồng tĩnh (GET), động (POST) và phiên (POST).
  </Info>
  <CodeGroup>
...
<Tab title="Xử lý Webhook">
  <Info>
  Sử dụng trình xử lý này để nhận và xử lý các sự kiện webhook của Dodo Payments một cách an toàn trong ứng dụng Hono của bạn.
  </Info>
  <CodeGroup>
...
<Info>
Dodo Payments hỗ trợ ba loại luồng thanh toán để tích hợp thanh toán vào trang web của bạn, adaptor này hỗ trợ tất cả các loại luồng thanh toán.
</Info>
