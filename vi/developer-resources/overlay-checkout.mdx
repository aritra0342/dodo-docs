...
1. **Khởi tạo một lần**: Khởi tạo SDK một lần khi ứng dụng của bạn tải, không phải trong mỗi lần thử thanh toán
2. **Xử lý lỗi**: Luôn thực hiện xử lý lỗi đúng cách trong callback sự kiện của bạn
...
6. **TypeScript**: Sử dụng TypeScript để có độ an toàn kiểu tốt hơn và trải nghiệm phát triển tốt hơn
...
9. **Quản lý bộ đếm thời gian**: Vô hiệu hóa bộ đếm thời gian (`showTimer: false`) nếu bạn muốn xử lý hết hạn phiên một cách thủ công
