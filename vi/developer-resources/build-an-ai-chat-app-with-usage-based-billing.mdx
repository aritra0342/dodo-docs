...
**Tên Đồng hồ** → `AI Token Usage Meter`
...
**Tổng hợp Trên**: Nhập → `totalTokens`

**Đơn vị Đo lường**: Nhập → `tokens`
...
1. Trong bảng điều khiển Dodo Payments của bạn, đi tới **Nhà phát triển** → **Khóa API**
...
**Giá mỗi Đơn vị**: Nhập → `0.00001` (đây là 0,01 USD cho 1.000 token hoặc 0,00001 USD cho mỗi token)
