...
<Note>
Thư viện API PHP Dodo Payments hiện đang ở **beta**. Chúng tôi rất hào hứng cho bạn thử nghiệm với nó! Vui lòng chia sẻ bất kỳ đề xuất, báo cáo lỗi hoặc yêu cầu tính năng nào bằng cách [gửi một vấn đề](https://github.com/dodopayments/dodopayments-php/issues).
</Note>
...
| Thời gian chờ      | `APITimeoutException`        |
