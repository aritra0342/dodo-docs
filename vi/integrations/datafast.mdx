...
<Step title="Cài đặt Script DataFast">
  Đầu tiên, cài đặt script theo dõi DataFast trên trang web của bạn. Điều này tạo ra cookie `datafast_visitor_id` theo dõi khách truy cập của bạn.
...
- Xem xét [tài liệu API Thanh toán của DataFast](https://datafa.st/docs/payments-api) để biết thêm hướng dẫn
</Accordion>
