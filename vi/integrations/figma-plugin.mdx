...
Nhân bản [kho dodopayments-figma](https://github.com/dodopayments/dodopayments-figma) và cập nhật `manifest.json` với tên và ID từ thư mục plugin được tạo của bạn.
