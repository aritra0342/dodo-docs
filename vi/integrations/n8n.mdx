...
<Step title="Mở phần Webhook">
  Trong bảng điều khiển Dodo Payments của bạn, điều hướng đến <b>Webhooks → + Thêm Điểm Kết Nối</b> và mở rộng menu thả xuống tích hợp.
  <Frame>
    <img src="/images/integrations/n8n.png" alt="Thêm Điểm Kết Nối và menu thả xuống tích hợp" />
  </Frame>
</Step>
...
<Step title="Tạo Webhook trong N8N">
  Trong N8N, tạo một quy trình làm việc mới và thêm một nút <b>Webhook</b> làm kích hoạt. Cấu hình nó như một webhook POST và sao chép URL webhook.
</Step>
...
<Step title="Kích Hoạt Quy Trình Làm Việc">
...
<AccordionGroup>
<Accordion title="Quy trình không kích hoạt">
...
<Accordion title="Lỗi thực thi quy trình làm việc">
