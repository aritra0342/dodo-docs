...
<CardGroup cols={3}>
<Card title="Lấy Ví Khách Hàng" icon="code" href="/api-reference/customers/get-customer-wallets">
  Kiểm tra số dư ví khách hàng trên các loại tiền tệ.
</Card>

<Card title="Tạo Mục Sổ Kế Toán" icon="plus" href="/api-reference/customers/post-customer-wallets-ledger-entries">
  Thêm hoặc xóa tín dụng từ ví khách hàng.
</Card>

<Card title="Danh Sách Mục Sổ Kế Toán" icon="list" href="/api-reference/customers/get-customer-wallets-ledger-entries">
  Xem lịch sử giao dịch đầy đủ với phân trang.
</Card>
</CardGroup>
...
<Info>
Hiện tại, chỉ có số dư <strong>USD</strong> và <strong>INR</strong> là có sẵn. Nhiều loại tiền tệ khác sẽ sớm có mặt.
</Info>
...
<Card title="Lấy Số Dư Ví Khách Hàng" icon="wallet" href="/api-reference/customers/get-customer-wallets">
...
<Card title="Tạo Mục Sổ Kế Toán Ví Khách Hàng" icon="plus" href="/api-reference/customers/post-customer-wallets-ledger-entries">
...
<Card title="Danh Sách Mục Sổ Kế Toán Ví Khách Hàng" icon="list" href="/api-reference/customers/get-customer-wallets-ledger-entries">
...
<Steps>
<Step title="Chào Mừng Khách Hàng Mới">
...
<Accordion title="Khách Hàng Ấn Độ">
