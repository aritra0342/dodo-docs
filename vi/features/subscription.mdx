...
<Info>
Tín dụng từ việc hạ cấp sử dụng `difference_immediately` là phạm vi đăng ký và tự động áp dụng cho các lần gia hạn trong tương lai. Chúng khác với <a href="/features/customer-credit">Tín dụng Khách Hàng</a>.
</Info>
...
## Đăng Ký Với Các Mệnh Lệnh Tuân Thủ RBI
  ...
  - **Phí dưới 15.000 Rs:** Chúng tôi tạo một mệnh lệnh theo yêu cầu cho 15.000 INR. Số tiền đăng ký sẽ được tính phí định kỳ theo tần suất đăng ký của bạn, cho đến giới hạn của mệnh lệnh.
  ...
  **Quan trọng:** Khi nâng cấp hoặc hạ cấp các đăng ký, hãy cân nhắc kỹ lưỡng các giới hạn mệnh lệnh:
  ...
  - Nếu việc nâng cấp/giảm cấp dẫn đến một số tiền phí vượt quá 15.000 Rs và vượt quá giới hạn thanh toán theo yêu cầu hiện tại, phí giao dịch có thể không thành công.
