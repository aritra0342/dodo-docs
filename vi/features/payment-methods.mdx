...
<Note>
Mỗi giao dịch phải đáp ứng <strong>số tiền tối thiểu yêu cầu cho mỗi đồng tiền</strong>. Đối với USD, số tiền tối thiểu là <strong>0.50 USD</strong>. Các mức tối thiểu cho các đồng tiền khác thay đổi theo vùng.
[Xem Các Đồng Tiền Hỗ Trợ &amp; Mức Tối Thiểu](/features/adaptive-currency#supported-currencies)
</Note>

<Note>
Klarna và Afterpay yêu cầu một số tiền giao dịch tối thiểu là <strong>50.01 USD</strong> (hoặc tương đương trong các đồng tiền hỗ trợ) để đủ điều kiện tại quy trình thanh toán. Các giao dịch dưới ngưỡng này sẽ không đủ điều kiện cho các tùy chọn thanh toán BNPL này. 

Để biết chi tiết về các quốc gia hỗ trợ của Klarna, hãy tham khảo <a href="#buy-now-pay-later-bnpl">phần BNPL</a> bên dưới.
</Note>
...
<CardGroup cols={3}>
  <Card title="Tạo Phiên Thanh Toán" icon="cart-shopping" href="/api-reference/checkout-sessions/create">
    Tạo các phiên thanh toán với các phương thức thanh toán được phép.
  </Card>
...
<Accordion title="Cân nhắc theo vùng">
...
<AccordionGroup>
<Accordion title="Phương thức thanh toán không xuất hiện tại quy trình thanh toán">
**Nguyên nhân có thể:**
...
<Accordion title="Phương thức thanh toán theo vùng không có sẵn">
**Nguyên nhân có thể:**
...
**Lỗi thu phí đăng ký sau khi nâng cấp/giảm cấp:**
- Số tiền thu phí mới có thể vượt quá giới hạn ủy quyền hiện tại (ngưỡng 15.000 Rs)
- Khách hàng có thể cần cập nhật phương thức thanh toán của họ để thiết lập một ủy quyền mới
...
**Đăng ký bị tạm hoãn sau khi khởi tạo thu phí:**
- Khách hàng có thể đã hủy ủy quyền trong khoảng thời gian xử lý 48 giờ
- Khách hàng có thể đã không ủy quyền cho một khoản thu phí có giá trị cao (≥15.000 Rs)

**Giải pháp:** Theo dõi các sự kiện webhook cho các hủy bỏ mệnh lệnh và các giao dịch không thành công. Triển khai logic thử lại hoặc nhắc nhở khách hàng thiết lập lại phương thức thanh toán của họ.
...
**Đối với các đăng ký đang tạm hoãn:**
Khi một đăng ký đang ở trạng thái `on_hold` (do thanh toán không thành công hoặc phí thay đổi kế hoạch không thành công), việc cập nhật phương thức thanh toán sẽ:
