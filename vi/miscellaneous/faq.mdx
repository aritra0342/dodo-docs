...
<Accordion title="Q20: Tại sao xác minh của tôi mất nhiều thời gian như vậy?">
...
<Accordion title="Q21: Tôi đã nộp mẫu W-8BEN của mình, nhưng phần chữ ký không hoạt động đúng cách. Tôi phải làm gì?">
...
<Accordion title="Q22: Tôi đã chọn sai loại đăng ký (doanh nghiệp so với cá nhân). Làm thế nào tôi có thể sửa nó?">
  A: Nếu bạn đã chọn sai loại thực thể (ví dụ: chọn "Tổ chức" nhưng bạn là cá nhân hoặc một chủ sở hữu duy nhất có GST), xác minh của bạn có thể đang bị giữ lại, yêu cầu bạn thay đổi hoặc cập nhật tài liệu. 

  Các bước để sửa:
  Bước 1: Thông báo cho hỗ trợ qua Intercom hoặc Discord, người sẽ giúp bạn kích hoạt nộp lại cho mẫu Tuân thủ Thanh toán.
  Bước 2: Chọn loại đăng ký đúng và nộp lại các tài liệu cần thiết.

</Accordion>

<Accordion title="Q23: Xác minh của tôi đã bị từ chối do không khớp thực thể. Tôi nên làm gì?">
  A: Nếu xác minh của bạn bị từ chối do không khớp thực thể (ví dụ: bạn đã chọn "Tổ chức" nhưng bạn là cá nhân hoặc một chủ sở hữu duy nhất có GST), bạn sẽ cần sửa đổi loại đăng ký và nộp lại tài liệu của mình.

  Các bước để sửa:
  Bước 1: Kiểm tra bảng điều khiển hoặc email của bạn để biết lý do cụ thể cho việc từ chối.
  Bước 2: Liên hệ với hỗ trợ qua Intercom hoặc email hỗ trợ (support@dodopayments.com) để yêu cầu quyền truy cập nộp lại cho mẫu Tuân thủ Thanh toán.
...
<Accordion title="Q24: Tôi đã đạt $100 trong thu nhập. Tài khoản của tôi sẽ được xác minh nhanh hơn không?">
...
<Accordion title="Q25: Tôi có thể sử dụng một tên khác (như tên của cha mẹ tôi) để đăng ký và được xác minh không?">
...
<Accordion title="Q26: Làm thế nào tôi kiểm tra lý do từ chối xác minh?">
...
<Accordion title="Q27: Tôi có thể tạo một tài khoản doanh nghiệp mới nếu tài khoản trước của tôi bị từ chối không?">
  A: Có — nhưng chỉ nếu:
...
<Accordion title="Q28: Tôi đã được thông báo rằng tài khoản của tôi đã bị xóa trước đó. Điều này có nghĩa là gì?">
...
<Accordion title="Q29: Làm thế nào tôi có thể làm cho việc xác minh thanh toán của mình nhanh hơn?">
  A: Để tránh chậm trễ:
...
<Accordion title="Q30: Điều gì sẽ xảy ra nếu tôi chọn sai mẫu (W-8BEN so với W-8BEN-E)?">
...
<Accordion title="Q31: Tôi có GST với tên thương mại. Điều đó có được coi là một tổ chức không?">
  A: Không. Nếu bạn đã đăng ký với GST như một cá nhân (chủ sở hữu duy nhất), bạn vẫn được coi là một Cá nhân.
...
<Accordion title="Q32: Tài khoản của tôi đã bị xóa. Tôi có thể chỉ cần tạo một tài khoản mới không?">
  ...
  <Tip>
  Nếu bạn tin rằng bạn đã bị xóa sai, hãy gửi email đến compliance@dodopayments.com với trường hợp của bạn.
  </Tip>
</Accordion>

<Accordion title="Q33: Dodo Payments xử lý GST cho các thương nhân SaaS Ấn Độ như thế nào?">
  A: Dodo Payments tự động tính toán và áp dụng **GST** cho các thương nhân Ấn Độ dựa trên vị trí của khách hàng của bạn.
</Accordion>

<Accordion title="Q34: Dodo Payments có xử lý các giao dịch quốc tế không?">
  A: Có, Dodo Payments hỗ trợ các giao dịch quốc tế và quản lý tất cả các tuân thủ liên quan.
</Accordion>

<Accordion title="Q35: Các dữ liệu địa chỉ như thành phố, tiểu bang, mã bưu điện có bắt buộc không? Tôi có thể loại bỏ yêu cầu những giá trị đó từ khách hàng của mình không?">
...
<Accordion title="Q36: Tôi có cần nộp thuế ở Mỹ nếu tôi bán hàng ở đó không?">
...
<Accordion title="Q37: Tôi không biết có nên điền W-8BEN hay W-8BEN-E — giúp tôi với?">
  A: Sử dụng logic sau để xác định mẫu nào bạn cần:

  | Bạn là... | Mẫu để Nộp | Loại Người bán |
  |------------|----------------|---------------|
  | Chủ sở hữu duy nhất, Freelancer, Cá nhân | W-8BEN | Cá nhân |
...
<Accordion title="Q38: Tôi có cần PAN hoặc GST để nhận thanh toán không?">
...
<Accordion title="Q39: Tôi có chứng nhận Udyam/MSME. Tôi nên nộp W-8BEN hay W-8BEN-E?">
...
<Accordion title="Q40: Nếu Dodo xử lý thuế, tại sao tôi cần nộp W-8BEN(-E)?">
...
<Accordion title="Q41: Tôi có thể chấp nhận những loại thanh toán nào với Dodo Payments?">
...
<Accordion title="Q42: Tại sao khoản thanh toán đầu tiên được đánh dấu là thành công với số tiền $0 cho đăng ký?">
...
<Accordion title="Q43: Sau khi thời gian dùng thử kết thúc, khách hàng có cần thanh toán (giá sản phẩm (ví dụ $25)) một lần nữa không?">
...
<Accordion title="Q44: Điều gì sẽ xảy ra nếu thời gian dùng thử hiển thị khác nhau trên ứng dụng của tôi so với bảng điều khiển Dodo Payments?">
...
<Accordion title="Q45: Tôi có cần thử nghiệm tính năng dùng thử trước khi đi vào hoạt động không?">
...
<Accordion title="Q46: Làm thế nào tôi có thể theo dõi trạng thái thanh toán?">
...
<Accordion title="Q47: Tôi nên làm gì nếu một khoản thanh toán thất bại?">
...
<Accordion title="Q48: Các thương nhân có được thông báo khi thanh toán của người dùng thất bại không?">
...
<Accordion title="Q49: Điều gì sẽ xảy ra với một đăng ký nếu một khoản thanh toán thất bại?">
  A: Đăng ký sẽ không bị hủy ngay lập tức. Thay vào đó, nó sẽ được chuyển sang trạng thái chờ cho đến khi một khoản thanh toán thành công được thực hiện.

  Nếu bạn gặp vấn đề với thẻ, bạn có thể cập nhật phương thức thanh toán bằng cách:
  - Nhấp vào đăng ký đang chờ trong bảng điều khiển của bạn và sử dụng nút **Cập nhật Phương thức Thanh toán**
  - Hoặc sử dụng điểm cuối API: https://docs.dodopayments.com/api-reference/subscriptions/update-payment-method
</Accordion>

<Accordion title="Q50: Nếu tôi tự thử lại các khoản thanh toán, tôi có cần ID thanh toán thất bại không?">
  A: Không. Bạn chỉ cần ID đăng ký để khởi động một lần thử thanh toán mới.
</Accordion>

<Accordion title="Q51: Làm thế nào một khoản thanh toán đăng ký có thể thất bại với INCORRECT_NUMBER nếu các chu kỳ trước đó đã thành công?">
...
<Accordion title="Q52: Có áp dụng chargeback cho doanh nghiệp ngay cả khi doanh nghiệp của tôi có chính sách không hoàn tiền không?">
...
<Accordion title="Q53: Tại sao payment.status đôi khi lại null?">
...
<Accordion title="Q54: Tại sao product_cart lại null ngay cả khi đó là một quy trình thanh toán?">
  A:
...
<Accordion title="Q55: Tại sao thẻ thực của tôi bị chặn trong quá trình thử nghiệm?">
  A: Bạn có thể đã thử nghiệm trong Chế độ Trực tiếp thay vì Chế độ Kiểm tra.

  Các khoản thanh toán trực tiếp:
  - Sử dụng tiền thật
...
<Accordion title="Q56: Khách hàng của tôi đã hoàn tất thanh toán nhưng tôi không nhận được webhook?">
...
<Accordion title="Q57: Tại sao bảng điều khiển của tôi hiển thị thành công, nhưng ứng dụng của tôi không cập nhật?">
...
<Accordion title="Q58: Tôi không thấy UPI là một tùy chọn thanh toán — tại sao?">
...
<Accordion title="Q59: Dodo có hỗ trợ UPI cho các đăng ký không?">
...
<Accordion title="Q60: Làm thế nào tôi có thể kích hoạt Google Pay / Apple Pay trên các liên kết thanh toán tĩnh?">
...
<Accordion title="Q61: Làm thế nào tôi có thể kích hoạt 3DS trong Dodo Payments?">
...
<Accordion title="Q62: Làm thế nào tôi có thể thu thập thông tin thanh toán mà không cần truyền chúng qua API?">
...
<Accordion title="Q63: Sự khác biệt giữa các liên kết thanh toán tĩnh và động là gì?">
...
<Accordion title="Q64: Tôi có nhận được hai sự kiện webhook khi ai đó bắt đầu một đăng ký không?">
...
<Accordion title="Q65: subscription.cancelled_at có nghĩa là gì? Có phải là một sự hủy bỏ đã lên lịch không?">
...
<Accordion title="Q66: Khi nào một đăng ký được tính phí?">
...
<Accordion title="Q67: Tại sao API Thay đổi Kế hoạch trả về phản hồi trống?">
...
<Accordion title="Q68: Tại sao không có khoản thanh toán mới được yêu cầu khi chuyển từ kế hoạch hàng tháng sang hàng năm?">
...
<Accordion title="Q69: Tại sao giá sản phẩm của tôi (₹100) hiển thị một số tiền cao hơn (₹104) trong quá trình thanh toán?">
  A: Điều này xảy ra khi Tính năng Tiền tệ Thích ứng được kích hoạt. Tính năng này tự động thêm một khoản phí bổ sung 4%.
</Accordion>

<Accordion title="Q70: Tại sao quá trình thanh toán bỏ qua các đăng ký đang hoạt động hiện có và tạo một cái mới?">
...
<Accordion title="Q71: Tại sao tôi thấy lỗi TRANSACTION_NOT_ALLOWED trong quá trình nâng cấp/hạ cấp đăng ký?">
...
<Accordion title="Q72: Có cách nào để thử nghiệm trong chế độ trực tiếp mà không cần thực hiện các khoản thanh toán thực không?">
...
<Accordion title="Q73: Phương thức thanh toán $0 là gì?">
...
<Accordion title="Q74: Có vẻ như tài khoản của tôi bị đình chỉ, nhưng bộ phận tuân thủ nói rằng mọi thứ đều ổn. Tôi nên làm gì?">
...
<Accordion title="Q76: Ngưỡng tối thiểu là bao nhiêu sau khi trừ phí & thuế để xử lý thanh toán?">
  A: Ngưỡng thanh toán tối thiểu là **$50 USD** (hoặc ₹1,000 INR) sau khi trừ phí nền tảng và thuế. Bạn có thể tùy chỉnh ngưỡng ví USD của mình thành bất kỳ số tiền nào **≥ $50** trực tiếp từ bảng điều khiển của bạn. Nếu số dư của bạn không đạt ngưỡng, nó sẽ được chuyển sang chu kỳ thanh toán tiếp theo.
...
<Accordion title="Q77: Làm thế nào tôi có thể liên kết tài khoản ngân hàng của mình để nhận thanh toán?">
...
<Accordion title="Q78: Tôi có thể theo dõi trạng thái thanh toán của mình không?">
  A: Có, bạn có thể theo dõi trạng thái thanh toán của mình từ phần **Thanh toán** của bảng điều khiển.
</Accordion>

<Accordion title="Q79: Phí thanh toán là gì và chúng là bao nhiêu?">
  A: Phí thanh toán đề cập đến chi phí giao dịch để chuyển tiền mà chúng tôi đã thu thập từ khách hàng của bạn đến tài khoản ngân hàng của bạn. Chúng tôi liên tục cải thiện để giảm phí thanh toán bằng cách hợp tác với các đối tác địa phương trong quốc gia của bạn. Vui lòng tham khảo [cấu trúc giá và phí](/miscellaneous/pricing-and-fee-structure#2-payout-fees) để biết thông tin chi tiết.
</Accordion>

<Accordion title="Q80: Tôi đã nhận được email 'thanh toán đã được xử lý' — khi nào thì tiền sẽ đến?">
...
<Accordion title="Q81: Làm thế nào tôi có thể thêm Payoneer làm tài khoản thanh toán?">
...
<Accordion title="Q82: Tôi có thể nhận thanh toán vào tài khoản Payoneer không?">
...
<Accordion title="Q83: Thông tin ngân hàng và mẫu tuân thủ của tôi vẫn đang được xem xét — tôi nên làm gì?">
...
<Accordion title="Q84: Điều gì sẽ xảy ra nếu ngày thanh toán của tôi rơi vào thứ Sáu hoặc cuối tuần?">
...
<Accordion title="Q85: Làm thế nào tôi có thể tăng tốc độ tuân thủ thanh toán nếu tôi có một buổi ra mắt hoặc chiến dịch quảng cáo khẩn cấp?">
...
<Accordion title="Q86: Tôi đã nộp thông tin tài khoản ngân hàng sai. Làm thế nào tôi có thể cập nhật chúng?">
...
<Accordion title="Q87: Tôi có thể sử dụng tài khoản ngân hàng cá nhân của mình nếu tôi có một công ty đã đăng ký không?">
  A: Không. Nếu bạn đã đăng ký là một công ty hoặc thực thể pháp lý, bạn phải sử dụng tài khoản ngân hàng của thực thể đó.
</Accordion>

<Accordion title="Q88: Quốc gia của tôi không sử dụng mã SWIFT. Điều đó sẽ ảnh hưởng đến việc xác minh của tôi như thế nào?">
  ...
  <Note>
  Trường hợp này sẽ trải qua xem xét tuân thủ thủ công. Để xử lý nhanh hơn, hãy viết email đến compliance@dodopayments.com để được tăng tốc.
  </Note>
</Accordion>

<Accordion title="Q89: Tôi có thể cung cấp tài liệu thay thế nào nếu quốc gia của tôi không sử dụng mã SWIFT?">
  ...
  <Tip>
  Liên hệ với support@dodopayments.com trước khi nộp để đảm bảo bạn cung cấp định dạng tài liệu chính xác cho quốc gia của mình.
  </Tip>
</Accordion>

## Hóa đơn & Báo cáo

<Accordion title="Q90: Dodo Payments có tự động tạo hóa đơn không?">
...
<Accordion title="Q91: Tôi có thể tùy chỉnh hóa đơn không?">
...
<Accordion title="Q92: Làm thế nào tôi có thể truy cập hoặc tải xuống hóa đơn?">
...
<Accordion title="Q93: Làm thế nào tôi có thể xem báo cáo về các giao dịch và thanh toán của mình?">
...
<Accordion title="Q94: Làm thế nào tôi có thể phát hành hoàn tiền?">
...
<Accordion title="Q95: Mất bao lâu để khách hàng nhận được hoàn tiền?">
...
<Accordion title="Q96: Tôi đang gặp phải một tranh chấp hoặc chargeback. Tôi có thể làm gì?">
...
<Accordion title="Q97: Khách hàng đã tranh chấp khoản phí sau khi sử dụng dịch vụ. Tôi có thể kháng cáo điều này không?">
  A: Có — bạn có thể:
...
<Accordion title="Q98: Tôi có thể xác minh thủ công các webhook của Dodo Payments trong Python không?">
...
<Accordion title="Q99: Tôi có thể tìm thấy tài liệu chính thức về xác minh webhook thủ công ở đâu?">
...
<Accordion title="Q100: Webhook của tôi không nhận được yêu cầu POST, chỉ nhận GET. Tại sao?">
...
<Accordion title="Q101: Tôi nhận được lỗi 401 Unauthorized khi sử dụng SDK Python. Tại sao?">
...
<Accordion title="Q102: Có cách nào để kích hoạt một sự kiện webhook cho thử nghiệm không?">
A: Bạn có thể làm điều này thông qua bảng điều khiển webhook. Đi tới Bảng điều khiển -> Nhà phát triển -> Webhooks
</Accordion>

<Accordion title="Q103: Sự khác biệt giữa webhook và URL chuyển hướng là gì?">
A:
...
<Accordion title="Q104: Tại sao tôi không nhận được ID sản phẩm trong webhook payment.succeeded cho một sản phẩm đăng ký?">
...
<Accordion title="Q105: Làm thế nào tôi có thể xác minh rằng các webhook tôi nhận được thực sự từ Dodo Payments và không phải từ bất kỳ tác nhân độc hại nào?">
...
<Tip>Chúng tôi khuyến nghị sử dụng các gói do StandardWebhooks cung cấp để xác minh chữ ký và không tự xây dựng nó.</Tip>
</Accordion>

<Accordion title="Q106: Tại sao tôi nhận được một webhook subscription.renew ngay cả khi thanh toán tháng đầu tiên?">
...
<Accordion title="Q107: Làm thế nào tôi có thể thử nghiệm các webhook cục bộ?">
...
<Accordion title="Q108: Tại sao webhook của tôi không được gọi sau khi thanh toán?">
...
<Accordion title="Q109: Có an toàn khi dựa vào status=success trong các tham số truy vấn URL không?">
A: Không. Mặc dù đây là một cách nhanh chóng, các tham số truy vấn URL có thể bị giả mạo.
...
<Accordion title="Q110: Tôi có thể tích hợp Dodo Payments với trang web hoặc nền tảng hiện có của mình không?">
...
<Accordion title="Q111: Tôi có thể thử nghiệm các đăng ký trong Chế độ Kiểm tra không?">
A: Có — các đăng ký có thể được thử nghiệm hoàn toàn trong Chế độ Kiểm tra.

Chỉ cần không sử dụng số thẻ thực.
</Accordion>

<Accordion title="Q112: Làm thế nào tôi có thể chuyển đổi giữa Chế độ Kiểm tra và Chế độ Trực tiếp?">
A:
...
<Accordion title="Q113: Tôi có thể sử dụng dữ liệu khách hàng thực trong Chế độ Kiểm tra không?">
A: Có, nhưng hãy nhớ:
...
<Accordion title="Q114: Tôi đang nhận được: 'Bạn phải cung cấp một ủy quyền cho các khoản thanh toán thẻ ngoài phiên'">
...
<Accordion title="Q115: Làm thế nào tôi có thể liên hệ với hỗ trợ?">
...
<Accordion title="Q116: Tin nhắn hỗ trợ của tôi không nhận được phản hồi. Tôi nên làm gì?">
...
<Accordion title="Q117: Dodo Payments bảo vệ doanh nghiệp của tôi khỏi gian lận như thế nào?">
...
<Accordion title="Q118: Dữ liệu khách hàng của tôi có an toàn với Dodo Payments không?">
...
<Accordion title="Q119: Tôi đã phát hiện ra một lỗ hổng bảo mật trong Dodo Payments. Tôi nên báo cáo nó như thế nào?">
...
<Accordion title="Q120: Dodo Payments có cung cấp phần thưởng cho lỗi không?">
