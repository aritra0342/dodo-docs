...
<Steps>
<Step title="Umwandlungsverfolgung in Dub aktivieren">
  ...
  <Info>
  Erfahren Sie mehr über die Aktivierung der Umwandlungsverfolgung in der [Dub-Dokumentation](https://dub.co/docs/conversions/quickstart).
  </Info>
</Step>

<Step title="Holen Sie sich Ihren Dub-API-Schlüssel">
  Navigieren Sie zu Ihrem [Dub-Dashboard](https://app.dub.co) → Einstellungen → API-Schlüssel und erstellen Sie einen neuen API-Schlüssel mit `conversions.write` Berechtigung.
