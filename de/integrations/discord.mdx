...
<Step title="Webhook-Bereich öffnen">
  Öffnen Sie in Ihrem Dodo Payments Dashboard <b>Webhooks → + Endpunkt hinzufügen</b> und erweitern Sie das Dropdown-Menü, um die Integrationen anzuzeigen.
  <Frame>
...
<Step title="Testen & Erstellen">
  Verwenden Sie Beispiel-Payloads, um das Embed in der Vorschau anzuzeigen, und klicken Sie dann auf <b>Erstellen</b>.
</Step>
