...
<Step title="Webhook-Bereich öffnen">
  ...
  <Frame>
    <img src="/images/integrations/close-crm.png" alt="Endpoint hinzufügen und Dropdown-Menü für Integrationen" />
  </Frame>
</Step>
...
<AccordionGroup>
<Accordion title="Datensätze wurden nicht in Close CRM erstellt">
