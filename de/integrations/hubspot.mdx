...
<Step title="Webhook-Bereich öffnen">
  Gehen Sie in Ihrem Dodo Payments-Dashboard zu <b>Webhooks → + Endpoint hinzufügen</b> und erweitern Sie das Dropdown-Menü für Integrationen.
  <Frame>
    <img src="/images/integrations/hubspot.png" alt="Endpoint hinzufügen und Dropdown-Menü für Integrationen" />
  </Frame>
</Step>
