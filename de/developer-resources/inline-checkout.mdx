...
Laden Sie die Datei auf Ihren Webserver unter `/.well-known/apple-developer-merchantid-domain-association` hoch. Wenn Ihre Website z. B. `example.com` ist, stellen Sie die Datei unter `https://example.com/well-known/apple-developer-merchantid-domain-association` zur Verfügung.
