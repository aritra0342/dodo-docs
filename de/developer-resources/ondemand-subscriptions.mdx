...
<Accordion title="Anforderungs-Body-Parameter">
  ...
  <ParamField body="payment_link" type="boolean" default="false">
    Wenn wahr, wird ein gehosteter Kassenlink zur Genehmigung des Mandats und optionalen Anfangszahlung erstellt.
  </ParamField>
  ...
  <ParamField body="on_demand.product_currency" type="string">
    Optionale Währungsüberschreibung für die Anfangsgebühr. Standardmäßig wird die Produktwährung verwendet.
  </ParamField>

  <ParamField body="on_demand.product_description" type="string">
    Optionale Beschreibungsüberschreibung für Rechnungen und Positionen.
  </ParamField>
...
<AccordionGroup>
  <Accordion title="Zahlungsanforderungs-Body-Parameter">
    ...
    <ParamField body="product_description" type="string">
      Optionale Beschreibungsüberschreibung für diese Zahlung.
    </ParamField>
...
- Pflegen und referenzieren Sie den Zeitstempel der letzten erfolgreichen Zahlung `T`, um den nächsten Versuch zu berechnen; bündeln Sie nicht mehrere Abonnements zur gleichen Zeit.
