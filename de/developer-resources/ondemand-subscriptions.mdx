...
<Accordion title="Anforderungs-Body-Parameter">
  ...
  <ParamField body="on_demand.product_price" type="integer">
    Betrag der Anfangsgebühr (in der kleinsten Währungseinheit). Wenn angegeben, überschreibt dieser Wert den ursprünglichen Preis des Produkts, der während der Produktcreation festgelegt wurde. Wenn weggelassen, wird der gespeicherte Preis des Produkts verwendet. Beispiel: Um $1,00 zu berechnen, übergeben Sie <code>100</code>.
  </ParamField>
...
Nachdem das Mandat genehmigt wurde, erstellen Sie nach Bedarf Gebühren.
...
Implementieren Sie die Webhook-Verarbeitung, um die Kundenreise zu verfolgen. Siehe [Implementing Webhooks](/developer-resources/integration-guide#implementing-webhooks).
