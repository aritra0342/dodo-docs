...
2. Bestätigen Sie, dass `customer_id` mit dem Abonnent übereinstimmt
...
**Lösungen**:
1. Verwenden Sie `previewChangePlan` API, um die genauen Gebühren vor der Bestätigung anzuzeigen
2. Kommunizieren Sie, dass die Proration sowohl für Abonnements als auch für Add-Ons gilt
3. Erwägen Sie die Verwendung von `difference_immediately` für einfachere Upgrade-Abrechnung
</Accordion>
