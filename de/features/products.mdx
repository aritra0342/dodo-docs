...
Sobald die vorab signierte URL von der API empfangen wurde, laden Sie das Bild mit der `PUT` Methode hoch. Dies gewährleistet sicheren und temporären Zugriff auf AWS S3 zum Hochladen des Bildes.
...
<Accordion title="Wiederherstellen eines Produkts">
